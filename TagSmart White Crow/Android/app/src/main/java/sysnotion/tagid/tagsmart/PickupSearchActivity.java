...
public class PickupSearchActivity  extends AppCompatActivity {
    ...
    private static final String TAG = PickupSearchActivity.class.getSimpleName();
    ...
    private PickupSearchActivity.SoundTask mSoundTask;
    //reader
    private BTReader mReader;
    private final PickupSearchActivity.BarcodeHandler mBarcodeHandler = new PickupSearchActivity.BarcodeHandler(this);
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedBarcodeList =  Constants.getArrayList(Constants.CATEGORY_ARRAY_JSON, PickupSearchActivity.this);
        ...
        pDialog = new ProgressDialog(PickupSearchActivity.this);

        if(Constants.isNetworkAvailable(PickupSearchActivity.this)) {
            new PickupSearchActivity.FetchBarcodeListAsyncTask(PickupSearchActivity.this).execute(Constants.BASE_URL+"GetPickupByBarcode.php");
        }
        else
        {
            Constants.internetAlert(PickupSearchActivity.this);
        }
        ...
        nextMoveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(selectedEPCList.size() > 0)
                {
                    ...
                    Constants.saveArrayList(mArrayProducts,Constants.CATEGORY_ARRAY_JSON, PickupSearchActivity.this);

                    Intent intent = new Intent(PickupSearchActivity.this , PickupMoveActivity.class);
                    startActivity(intent);
                    finish();
                }
                else
                {
                    Toast.makeText(PickupSearchActivity.this, "No EPC searched. Click on the row to search the barcode and asscoiated EPC's", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void SoundLoadListener() {
        if (mSoundPool != null) {
            ...
            mSoundId = mSoundPool.load(PickupSearchActivity.this, R.raw.beep, 1);
        }
    }
    ...
    {
        try {
            AlertDialog.Builder dialog = new AlertDialog.Builder(PickupSearchActivity.this);
            dialog.setTitle(title)
                    ...
                    .setPositiveButton("Bluetooth Settings", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialoginterface, int i) {
                            ...
                            Intent intent = new Intent(PickupSearchActivity.this, BTConnectivityActivity.class);
                            startActivity(intent);
                        }
                    }).show();
...
//          }})
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case R.id.sound: //Your task
                Intent intent2 = new Intent(PickupSearchActivity.this, SoundManagerActivity.class);
            ...
            case R.id.serial_reader: //Your task
                Intent intent3 = new Intent(PickupSearchActivity.this, SerialPickupSearchActivity.class);
    ...
    private static class BarcodeHandler extends Handler {
        private final WeakReference<PickupSearchActivity> mExecutor;
        public BarcodeHandler(PickupSearchActivity f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            PickupSearchActivity executor = mExecutor.get();
            if (executor != null) {
            ...
            case SDConsts.Msg.SDMsg:
                switch(m.arg1) {
                    ...
                    case SDConsts.SDCmdMsg.SLED_INVENTORY_STATE_CHANGED:
                        ...
                        Toast.makeText(PickupSearchActivity.this, "Inventory Stopped reason : " + m.arg2, Toast.LENGTH_SHORT).show();
                        break;
                    ...
                    case SDConsts.SDCmdMsg.SLED_HOTSWAP_STATE_CHANGED:
                        if (m.arg2 == SDConsts.SDHotswapState.HOTSWAP_STATE)
                            Toast.makeText(PickupSearchActivity.this, "HOTSWAP STATE CHANGED = HOTSWAP_STATE", Toast.LENGTH_SHORT).show();
                        else if (m.arg2 == SDConsts.SDHotswapState.NORMAL_STATE)
                            Toast.makeText(PickupSearchActivity.this, "HOTSWAP STATE CHANGED = NORMAL_STATE", Toast.LENGTH_SHORT).show();
                            ...
                            if (m.obj != null  && m.obj instanceof String) {
                                ...
                                if (data != null)
                                {
                                    ...
                                    if (data.contains(";")) {
                                        ...
                                        if (mSoundTask == null) {
                                            mSoundTask = new PickupSearchActivity.SoundTask();
                                            mSoundTask.execute();
                                        }
                                        else {
        ...
        startScanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ret == SDConsts.RFResult.SUCCESS) {
                    ...
                    Toast.makeText(PickupSearchActivity.this, "Scan failed, Please check RFR900 MODE", Toast.LENGTH_SHORT).show();
                else if (ret == SDConsts.RFResult.LOW_BATTERY)
                    Toast.makeText(PickupSearchActivity.this, "Scan   failed, LOW_BATTERY", Toast.LENGTH_SHORT).show();
                else
        ...
        stopScanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ret == SDConsts.RFResult.SUCCESS || ret == SDConsts.RFResult.NOT_INVENTORY_STATE) {
                    ...
                    Toast.makeText(PickupSearchActivity.this, "Stop Inventory failed", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        closeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(adapter != null) {
                    ...
                    if(mArrayProducts.size()> 0)
                    {
                        ...
                        if(selectedEPCList.size()>0)
                        {
                            try{
                                ...
                                new PickupSearchActivity.UpdateStatusAndQuantityAsyncTask(PickupSearchActivity.this,ean ,qty).execute(Constants.BASE_URL+"UpdatePickupStatusAndQuantity.php");
                    ...
                    {
                        Toast.makeText(PickupSearchActivity.this, "No EPC's are selected", Toast.LENGTH_SHORT).show();
                    }
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null)
            {
                try {
                    ...
                    TableRow tableRow = new TableRow(PickupSearchActivity.this);
                    ...
                    for (int j = 0; j < anchorIndex; j++) {   /* create cell element - textview */
                        TextView tv = new TextView(PickupSearchActivity.this);
                    ...
                    /* add views to the row */
                    tableRow.addView(tv);
                    TextView tv2 = new TextView(PickupSearchActivity.this);
                    ...
                    TextView tv3 = new TextView(PickupSearchActivity.this);
                    ...
                    TextView tv4 = new TextView(PickupSearchActivity.this);
                    ...
                    TextView tv5 = new TextView(PickupSearchActivity.this);
                    ...
                    for (int j = 0; j < barcodeDetailsArray.length(); j++) {
                        ...
                        TableRow tableRow2 = new TableRow(PickupSearchActivity.this);
                        ...
                        {
                            TextView tvr = new TextView(PickupSearchActivity.this);
                    ...
                    Toast.makeText(PickupSearchActivity.this, "Click on the row to search the barcode and asscoiated EPC's", Toast.LENGTH_SHORT).show();
                }
                catch(Exception e)
                {
                    e.printStackTrace();
                    Toast.makeText(PickupSearchActivity.this, "Something went wrong. Please try again", Toast.LENGTH_LONG).show();
                }
            }
