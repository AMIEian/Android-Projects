...
public class SerialSearchItemActivity  extends AppCompatActivity {
    private static final String TAG = SerialSearchItemActivity.class.getSimpleName();
    EditText barcodeScanTV,textET ;
    ImageButton barcodeScanBtn ;
    Reader reader=null;
    private final SerialSearchItemActivity.BarcodeHandler mBarcodeHandler = new SerialSearchItemActivity.BarcodeHandler(this);
    boolean isConnected;
    int readFlag = 0;
        ...
        textET.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(textET.getText().toString().trim().length()>=4 )
                {
                    ...
                    new  SearchByTextAsyncTask(SerialSearchItemActivity.this,txt).execute(Constants.BASE_URL + "GetDetailsByText.php");
        ...
        barcodeScanTV.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(barcodeScanTV.getText().toString().trim().length()>=4 )
                {
                    ...
                    new SerialSearchItemActivity.SearchByBarcodeAsyncTask(SerialSearchItemActivity.this,ean).execute(Constants.BASE_URL + "GetDetailsByBarcode.php");
        ...
        barcodeScanBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                if (ret == SDConsts.RFResult.SUCCESS)
                {
                    ...
                    Toast.makeText(SerialSearchItemActivity.this, "Start Inventory failed, Please check RFR900 MODE", Toast.LENGTH_SHORT).show();
                }else if (ret == SDConsts.RFResult.LOW_BATTERY){
                    Toast.makeText(SerialSearchItemActivity.this, "Start Inventory failed, LOW_BATTERY", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(SerialSearchItemActivity.this, "Start Inventory failed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        categoryListView.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position <= barcodeList.size())
                {
                    ...
                    Intent intent = new Intent(SerialSearchItemActivity.this , SerialLocationScanActivity.class);
    ...
    private static class BarcodeHandler extends Handler {
        private final WeakReference<SerialSearchItemActivity> mExecutor;
        public BarcodeHandler(SerialSearchItemActivity f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            SerialSearchItemActivity executor = mExecutor.get();
            if (executor != null) {
    ...
    {
        try {
            AlertDialog.Builder dialog = new AlertDialog.Builder(SerialSearchItemActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                return true;
            case R.id.sound:
                Intent intent2 = new Intent(SerialSearchItemActivity.this, SoundManagerActivity.class);
                startActivity(intent2);
                return true;
            case R.id.bluetooth_reader: //Your task
                Intent intent3 = new Intent(SerialSearchItemActivity.this, SearchItemActivity.class);
            ...
            if (result != null) {
                try
                {
                    ...
                    if (jObj.has("barcode_details")) {
                        ...
                        Toast.makeText(SerialSearchItemActivity.this, "Click row to activate the RFID tag locator", Toast.LENGTH_LONG).show();

                    }
                    else
                    {
                        Toast.makeText(SerialSearchItemActivity.this, "No item found", Toast.LENGTH_LONG).show();
                    }

                } catch (Exception e) {

                     e.printStackTrace();
                    Toast.makeText(SerialSearchItemActivity.this, "Something went wrong. Please try again", Toast.LENGTH_LONG).show();
                }
