...
public class VerifyTagActivity extends AppCompatActivity {
    TextView StoreIdTV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pDialog = new ProgressDialog(VerifyTagActivity.this);
        ...
        scanBarcodeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ret == SDConsts.RFResult.SUCCESS)
                {
                    ...
                    Toast.makeText(VerifyTagActivity.this, "Start Inventory failed, Please check RFR900 MODE", Toast.LENGTH_SHORT).show();
                }else if (ret == SDConsts.RFResult.LOW_BATTERY){
                    Toast.makeText(VerifyTagActivity.this, "Start Inventory failed, LOW_BATTERY", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(VerifyTagActivity.this, "Start Inventory failed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        GoToEncodeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(VerifyTagActivity.this , EncodingEPCActivity.class);
        ...
        if (Constants.isNetworkAvailable(VerifyTagActivity.this))
        {
            new  FetchBarcodeAndEPCAsyncTask(VerifyTagActivity.this).execute(Constants.BASE_URL + "GetEPCBarcodeMasterData.php");

        }
        else
        {
            Constants.internetAlert(VerifyTagActivity.this);
        ...
        try{
            ...
            if (reader.BT_GetConnectState() == SDConsts.BTConnectState.CONNECTED)
            {
                ...
                if(result==SDConsts.RFResult.SUCCESS)
                {
                    ...
                    if (result == SDConsts.RFResult.SUCCESS)
                    {
                        Toast.makeText(VerifyTagActivity.this, "Reading......", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
   ...
   /* @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.bluetooth_settings:
                Intent intent = new Intent(VerifyTagActivity.this, BTConnectivityActivity.class);
                startActivity(intent);
                return true;

            case R.id.sound:
                Intent intent2 = new Intent(VerifyTagActivity.this, SoundManagerActivity.class);
                startActivity(intent2);
                return true;

            case R.id.serial_reader:
                Intent intent3 = new Intent(VerifyTagActivity.this, SerialVerifyTagActivity.class);
    ...
    private static class BarcodeHandler extends Handler {
        private final WeakReference<VerifyTagActivity> mExecutor;
        public BarcodeHandler(VerifyTagActivity f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            VerifyTagActivity executor = mExecutor.get();
            if (executor != null) {
    ...
    {
        try {
            AlertDialog.Builder dialog = new AlertDialog.Builder(VerifyTagActivity.this);
