...
public class SerialReplenishmentMoveActivity  extends AppCompatActivity {
    private static final String TAG = SerialReplenishmentMoveActivity.class.getSimpleName();
    ...
    SerialReplenishmentMoveActivity.ProcessEPCAndUpdateUIAsyncTask processEPCAndUpdateUIAsyncTask;
    JSONArray barcodePositionArray = new JSONArray();
    private ProgressDialog pDialog;
    SerialReplenishmentMoveActivity.UpdateUIAsyncTask updateUIAsyncTask;
    int UIJSONLength=0;
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedEPCList =  Constants.getArrayList(Constants.CATEGORY_ARRAY_JSON, SerialReplenishmentMoveActivity.this);
        ...
        pDialog = new ProgressDialog(SerialReplenishmentMoveActivity.this);
        ...
        collapseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // new  ExpandCollapseAllAsyncTask(SerialReplenishmentMoveActivity.this,false).execute();
        ...
        expandButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // new  ExpandCollapseAllAsyncTask(SerialReplenishmentMoveActivity.this,true).execute();
                for(int i=0; i < inventoryAdapter.getGroupCount(); i++)
            ...
            public void onClick(View view) {
                ...
                if (!mInventory) {
                    ...
                    if (ret == SDConsts.RFResult.SUCCESS) {
                                ...
                                handler.post(new Runnable() {
                                    public void run() {
                                        if(scanFinished == 0)
                                        {
                                            ...
                                            processEPCAndUpdateUIAsyncTask = new SerialReplenishmentMoveActivity.ProcessEPCAndUpdateUIAsyncTask();
                                ...
                                handler2.post(new Runnable() {
                                    public void run() {
                                        if(uiUpdateFinished == 0)
                                        {
                                            ...
                                            updateUIAsyncTask = new SerialReplenishmentMoveActivity.UpdateUIAsyncTask();
                        ...
                        Toast.makeText(SerialReplenishmentMoveActivity.this, "Start Inventory failed, Please check RFR900 MODE", Toast.LENGTH_SHORT).show();
                    else if (ret == SDConsts.RFResult.LOW_BATTERY)
                        Toast.makeText(SerialReplenishmentMoveActivity.this, "Start Inventory failed, LOW_BATTERY", Toast.LENGTH_SHORT).show();
                    else
        ...
        finishScanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                        SerialReplenishmentMoveActivity.this);
                        ...
                        .setNegativeButton("Submit Stock Scan", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (ret == SDConsts.RFResult.SUCCESS || ret == SDConsts.RFResult.NOT_INVENTORY_STATE) {
                                    ...
                                    Toast.makeText(SerialReplenishmentMoveActivity.this, "Stop Inventory failed", Toast.LENGTH_SHORT).show();
    ...
    private void SoundLoadListener() {
        if (mSoundPool != null) {
            ...
            mSoundId = mSoundPool.load(SerialReplenishmentMoveActivity.this, R.raw.beep, 1);
        }
    }
    ...
    private static class BarcodeHandler extends Handler {
        private final WeakReference<SerialReplenishmentMoveActivity> mExecutor;
        public BarcodeHandler(SerialReplenishmentMoveActivity f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            SerialReplenishmentMoveActivity executor = mExecutor.get();
            if (executor != null) {
            ...
            case SDConsts.Msg.SDMsg:
                switch(m.arg1) {
                    ...
                    case SDConsts.SDCmdMsg.SLED_INVENTORY_STATE_CHANGED:
                        ...
                        Toast.makeText(SerialReplenishmentMoveActivity.this, "Inventory Stopped reason : " + m.arg2, Toast.LENGTH_SHORT).show();
                    ...
                    case SDConsts.SDCmdMsg.SLED_BATTERY_STATE_CHANGED:
                        //Toast.makeText(SerialReplenishmentMoveActivity.this, "Battery state = " + m.arg2, Toast.LENGTH_SHORT).show();
                    ...
                    case SDConsts.SDCmdMsg.SLED_HOTSWAP_STATE_CHANGED:
                        if (m.arg2 == SDConsts.SDHotswapState.HOTSWAP_STATE)
                            Toast.makeText(SerialReplenishmentMoveActivity.this, "HOTSWAP STATE CHANGED = HOTSWAP_STATE", Toast.LENGTH_SHORT).show();
                        else if (m.arg2 == SDConsts.SDHotswapState.NORMAL_STATE)
                            Toast.makeText(SerialReplenishmentMoveActivity.this, "HOTSWAP STATE CHANGED = NORMAL_STATE", Toast.LENGTH_SHORT).show();
                            ...
                            if (m.obj != null  && m.obj instanceof String) {
                                ...
                                if (data != null && isFinsihButtonPressed == 0)
                                {
                                    if (data.contains(";")) {
                                        ...
                                        if (mSoundTask == null) {
                                            mSoundTask = new SerialReplenishmentMoveActivity.SoundTask();
                                            mSoundTask.execute();
                                        }
                                        else {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        switch (item.getItemId())
        {
            ...
            case R.id.sound: //Your task
                Intent intent2 = new Intent(SerialReplenishmentMoveActivity.this, SoundManagerActivity.class);
                startActivity(intent2);
                return true;

            case R.id.bluetooth_reader:
                Intent intent3 = new Intent(SerialReplenishmentMoveActivity.this, ReplenishmentMoveActivity.class);
    ...
    private void showMessageDialog()
    {
        try {
            if (isFinsihButtonPressed == 1) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(SerialReplenishmentMoveActivity.this);
            ...
            dialog.setTitle(title)
                    ...
                    .setPositiveButton("Bluetooth Settings", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialoginterface, int i) {
                            ...
                            Intent intent = new Intent(SerialReplenishmentMoveActivity.this, BTConnectivityActivity.class);
    ...
    class ProcessEPCAndUpdateUIAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                {
                    Toast.makeText(SerialReplenishmentMoveActivity.this, "Something went wrong during updating epc to server", Toast.LENGTH_LONG).show();
                }
    ...
    class UpdateUIAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                inventoryAdapter = new ExpandableListAdapter(SerialReplenishmentMoveActivity.this, expandableTitleList, expandableDetailList);
