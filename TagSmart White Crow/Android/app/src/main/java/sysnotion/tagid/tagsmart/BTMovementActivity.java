...
public class BTMovementActivity extends AppCompatActivity {

    private static final String TAG = BTMovementActivity.class.getSimpleName();
    ...
    private BTMovementActivity.SoundTask mSoundTask;
    ...
    private final BTMovementActivity.BarcodeHandler mBarcodeHandler = new BTMovementActivity.BarcodeHandler(this);
    ...
    BTMovementActivity.ProcessEPCAndUpdateUIAsyncTask processEPCAndUpdateUIAsyncTask;
    JSONArray barcodePositionArray = new JSONArray();
    int lastLevel = 0;
    private ProgressDialog pDialog;
    String barcodesString= new String();
    BTMovementActivity.UpdateUIAsyncTask updateUIAsyncTask;
    int UIJSONLength=0;
...
"30361FAF541C59800000003E",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbManager = new DBManager(BTMovementActivity.this);
        dbManager.open();
        dbManager.turcateStockTakeChecksum();

        pDialog = new ProgressDialog(BTMovementActivity.this);

        sessionId = Constants.getSessionId(BTMovementActivity.this);
        isSessionNew = Constants.isSessionNew(BTMovementActivity.this);
        ...
        selectedBarcodeList =  Constants.getArrayList(Constants.CATEGORY_ARRAY_JSON, BTMovementActivity.this);
        colors= getResources().getIntArray(R.array.colors_hex_code);

        if(Constants.isNetworkAvailable(BTMovementActivity.this)) {
            new BTMovementActivity.LoadTreeAsyncTask(BTMovementActivity.this).execute(Constants.DOMAIN_URL+"product_tree_by_barcode.php");
        }
        else
        {
            Constants.internetAlert(BTMovementActivity.this);
        }
        ...
        collapseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new BTMovementActivity.ExpandCollapseAllAsyncTask(BTMovementActivity.this,false).execute();
            }
        });
        ...
        expandButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new BTMovementActivity.ExpandCollapseAllAsyncTask(BTMovementActivity.this,true).execute();
            }
        });
            ...
            public void onClick(View view) {
                ...
                if (!mInventory) {
                    ...
                    if (ret == SDConsts.RFResult.SUCCESS) {
                                ...
                                handler.post(new Runnable() {
                                    public void run() {
                                        if(scanFinished == 0)
                                        {
                                            ...
                                            processEPCAndUpdateUIAsyncTask = new BTMovementActivity.ProcessEPCAndUpdateUIAsyncTask();
                                ...
                                handler2.post(new Runnable() {
                                    public void run() {
                                        if(uiUpdateFinished == 0)
                                        {
                                            ...
                                            updateUIAsyncTask = new BTMovementActivity.UpdateUIAsyncTask();
                        ...
                        Toast.makeText(BTMovementActivity.this, "Start Inventory failed, Please check RFR900 MODE", Toast.LENGTH_SHORT).show();
                    else if (ret == SDConsts.RFResult.LOW_BATTERY)
                        Toast.makeText(BTMovementActivity.this, "Start Inventory failed, LOW_BATTERY", Toast.LENGTH_SHORT).show();
                    else
                ...
                alertDialogBuilder
                        ...
                        .setPositiveButton("Abandon Scan", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if(Constants.isNetworkAvailable(BTMovementActivity.this)) {
                                    new BTMovementActivity.RollbackStockTakeAsyncTask(BTMovementActivity.this).execute(Constants.BASE_URL+"RollBackStockTake.php");
                                }
                                else
                                {
                                    Constants.internetAlert(BTMovementActivity.this);
                                ...
                                if (ret == SDConsts.RFResult.SUCCESS || ret == SDConsts.RFResult.NOT_INVENTORY_STATE) {
                                    ...
                                    Toast.makeText(BTMovementActivity.this, "Stop Inventory failed", Toast.LENGTH_SHORT).show();
                ...
                if(isLast){
                    tv.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Toast.makeText(BTMovementActivity.this, "Clicked on: "+Title, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
    ...
    private void SoundLoadListener() {
        if (mSoundPool != null) {
            ...
            mSoundId = mSoundPool.load(BTMovementActivity.this, R.raw.beep, 1);
        }
    }
    ...
    private static class BarcodeHandler extends Handler {
        private final WeakReference<BTMovementActivity> mExecutor;
        public BarcodeHandler(BTMovementActivity f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            BTMovementActivity executor = mExecutor.get();
            if (executor != null) {
            ...
            case SDConsts.Msg.SDMsg:
                switch(m.arg1) {
                    ...
                    case SDConsts.SDCmdMsg.SLED_INVENTORY_STATE_CHANGED:
                        ...
                        Toast.makeText(BTMovementActivity.this, "Inventory Stopped reason : " + m.arg2, Toast.LENGTH_SHORT).show();
                    ...
                    case SDConsts.SDCmdMsg.SLED_BATTERY_STATE_CHANGED:
                        //Toast.makeText(BTMovementActivity.this, "Battery state = " + m.arg2, Toast.LENGTH_SHORT).show();
                    ...
                    case SDConsts.SDCmdMsg.SLED_HOTSWAP_STATE_CHANGED:
                        if (m.arg2 == SDConsts.SDHotswapState.HOTSWAP_STATE)
                            Toast.makeText(BTMovementActivity.this, "HOTSWAP STATE CHANGED = HOTSWAP_STATE", Toast.LENGTH_SHORT).show();
                        else if (m.arg2 == SDConsts.SDHotswapState.NORMAL_STATE)
                            Toast.makeText(BTMovementActivity.this, "HOTSWAP STATE CHANGED = NORMAL_STATE", Toast.LENGTH_SHORT).show();
                                ...
                                if (data != null && isFinsihButtonPressed == 0)
                                {
                                    if (data.contains(";")) {
                                        ...
                                        */
                                        ...
                                        if (mSoundTask == null) {
                                            mSoundTask = new BTMovementActivity.SoundTask();
                                            mSoundTask.execute();
                                        }
                                        else {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        switch (item.getItemId())
        {
            ...
            case R.id.bluetooth_settings: //Your task
                Intent intent = new Intent(BTMovementActivity.this, BTConnectivityActivity.class);
                startActivity(intent);
                return true;

            case R.id.sound: //Your task
                Intent intent2 = new Intent(BTMovementActivity.this, SoundManagerActivity.class);
                startActivity(intent2);

                return true;

            case R.id.serial_reader: //Your task
                Intent intent3 = new Intent(BTMovementActivity.this, SerialMovementActivity.class);
    ...
    private void showMessageDialog()
    {
        try {
            if (isFinsihButtonPressed == 1) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(BTMovementActivity.this);
    ...
    class ProcessEPCAndUpdateUIAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                {
                    if (isFinsihButtonPressed == 1) {
                        Intent intent = new Intent(BTMovementActivity.this , MovingSummaryActivity.class);
                ...
                {
                    Toast.makeText(BTMovementActivity.this, "Something went wrong during updating epc to server", Toast.LENGTH_LONG).show();
                }
    ...
    class RollbackStockTakeAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (status.compareTo("1") == 0) {
                    Toast.makeText(BTMovementActivity.this, msg, Toast.LENGTH_LONG).show();
                }
                else
                {
                    Toast.makeText(BTMovementActivity.this, msg, Toast.LENGTH_LONG).show();
