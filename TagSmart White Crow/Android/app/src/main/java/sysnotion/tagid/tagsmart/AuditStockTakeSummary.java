...
public class AuditStockTakeSummary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_audit_stock_take_summary);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        pref = getApplicationContext().getSharedPreferences(Constants.PREFS_NAME, MODE_PRIVATE);
        dbManager = new DBManager(AuditStockTakeSummary.this);

        pDialog = new ProgressDialog(AuditStockTakeSummary.this);
        ...
        if(Constants.isNetworkAvailable(AuditStockTakeSummary.this)) {
            new AuditStockTakeSummary.StockTakeSummaryAsyncTask(AuditStockTakeSummary.this).execute(Constants.BASE_URL+"AuditSummary.php");
        }
        else
        {
            Constants.internetAlert(AuditStockTakeSummary.this);
        }
    }
    ...
    class StockTakeSummaryAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... string) {
            ...
            try {
                ...
                String sessionId = Constants.getSessionId(AuditStockTakeSummary.this);
                ...
                String urlParameters = "user_id="+user_id+"&session_id="+sessionId+"&stock_table_name=" + stock_table_name+"&product_table_name=" + product_table_name+"&customer_id="+customer_id ;


                Log.d("AuditStockTakeSummary", "urlParameters "+ urlParameters);
        ...
        protected void onPostExecute(String result) {
            ...
            dismissProgressDialog();
            System.out.println("AuditStockTakeSummary Response "+result);
            ...
            if (result != null) {
                try
                {
                    ...
                    InventoryAdapter inAdapter = new InventoryAdapter(AuditStockTakeSummary.this,inList);
                    ...
                    // e.printStackTrace();
                    Toast.makeText(AuditStockTakeSummary.this, "Something went wrong. Please try again", Toast.LENGTH_LONG).show();
                }
