...
public class PickupMoveActivity extends AppCompatActivity {

    private static final String TAG = PickupMoveActivity.class.getSimpleName();
    ...
    private PickupMoveActivity.SoundTask mSoundTask;
    ...
    private final PickupMoveActivity.BarcodeHandler mBarcodeHandler = new PickupMoveActivity.BarcodeHandler(this);
    ...
    PickupMoveActivity.ProcessEPCAndUpdateUIAsyncTask processEPCAndUpdateUIAsyncTask;
    JSONArray barcodePositionArray = new JSONArray();
    private ProgressDialog pDialog;
    PickupMoveActivity.UpdateUIAsyncTask updateUIAsyncTask;
    int UIJSONLength=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedEPCList =  Constants.getArrayList(Constants.CATEGORY_ARRAY_JSON, PickupMoveActivity.this);
        ...
        pDialog = new ProgressDialog(PickupMoveActivity.this);
        ...
        collapseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // new  ExpandCollapseAllAsyncTask(PickupMoveActivity.this,false).execute();
        ...
        expandButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // new  ExpandCollapseAllAsyncTask(PickupMoveActivity.this,true).execute();
                for(int i=0; i < inventoryAdapter.getGroupCount(); i++)
            ...
            public void onClick(View view) {
                ...
                if (!mInventory) {
                    ...
                    if (ret == SDConsts.RFResult.SUCCESS) {
                                ...
                                handler.post(new Runnable() {
                                    public void run() {
                                        if(scanFinished == 0)
                                        {
                                            ...
                                            processEPCAndUpdateUIAsyncTask = new PickupMoveActivity.ProcessEPCAndUpdateUIAsyncTask();
                                ...
                                handler2.post(new Runnable() {
                                    public void run() {
                                        if(uiUpdateFinished == 0)
                                        {
                                            ...
                                            updateUIAsyncTask = new PickupMoveActivity.UpdateUIAsyncTask();
                        ...
                        Toast.makeText(PickupMoveActivity.this, "Start Inventory failed, Please check RFR900 MODE", Toast.LENGTH_SHORT).show();
                    else if (ret == SDConsts.RFResult.LOW_BATTERY)
                        Toast.makeText(PickupMoveActivity.this, "Start Inventory failed, LOW_BATTERY", Toast.LENGTH_SHORT).show();
                    else
                        ...
                        .setNegativeButton("Submit Stock Scan", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (ret == SDConsts.RFResult.SUCCESS || ret == SDConsts.RFResult.NOT_INVENTORY_STATE) {
                                    ...
                                    Toast.makeText(PickupMoveActivity.this, "Stop Inventory failed", Toast.LENGTH_SHORT).show();
    ...
    private void SoundLoadListener() {
        if (mSoundPool != null) {
            ...
            mSoundId = mSoundPool.load(PickupMoveActivity.this, R.raw.beep, 1);
        }
    }
    ...
    private static class BarcodeHandler extends Handler {
        private final WeakReference<PickupMoveActivity> mExecutor;
        public BarcodeHandler(PickupMoveActivity f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            PickupMoveActivity executor = mExecutor.get();
            if (executor != null) {
            ...
            case SDConsts.Msg.SDMsg:
                switch(m.arg1) {
                    ...
                    case SDConsts.SDCmdMsg.SLED_INVENTORY_STATE_CHANGED:
                        ...
                        Toast.makeText(PickupMoveActivity.this, "Inventory Stopped reason : " + m.arg2, Toast.LENGTH_SHORT).show();
                    ...
                    case SDConsts.SDCmdMsg.SLED_BATTERY_STATE_CHANGED:
                        //Toast.makeText(PickupMoveActivity.this, "Battery state = " + m.arg2, Toast.LENGTH_SHORT).show();
                    ...
                    case SDConsts.SDCmdMsg.SLED_HOTSWAP_STATE_CHANGED:
                        if (m.arg2 == SDConsts.SDHotswapState.HOTSWAP_STATE)
                            Toast.makeText(PickupMoveActivity.this, "HOTSWAP STATE CHANGED = HOTSWAP_STATE", Toast.LENGTH_SHORT).show();
                        else if (m.arg2 == SDConsts.SDHotswapState.NORMAL_STATE)
                            Toast.makeText(PickupMoveActivity.this, "HOTSWAP STATE CHANGED = NORMAL_STATE", Toast.LENGTH_SHORT).show();
                            ...
                            if (m.obj != null  && m.obj instanceof String) {
                                ...
                                if (data != null && isFinsihButtonPressed == 0)
                                {
                                    if (data.contains(";")) {
                                        ...
                                        if (mSoundTask == null) {
                                            mSoundTask = new PickupMoveActivity.SoundTask();
                                            mSoundTask.execute();
                                        }
                                        else {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        switch (item.getItemId())
        {
            ...
            case R.id.sound: //Your task
                Intent intent2 = new Intent(PickupMoveActivity.this, SoundManagerActivity.class);
                startActivity(intent2);
                return true;


            case R.id.bluetooth_settings: //Your task
                Intent intent = new Intent(PickupMoveActivity.this, BTConnectivityActivity.class);
                startActivity(intent);
                return true;

            case R.id.serial_reader:
                Intent intent3 = new Intent(PickupMoveActivity.this, SerialPickupMoveActivity.class);
    ...
    private void showMessageDialog()
    {
        try {
            if (isFinsihButtonPressed == 1) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(PickupMoveActivity.this);
    ...
    class ProcessEPCAndUpdateUIAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                {
                    Toast.makeText(PickupMoveActivity.this, "Something went wrong during updating epc to server", Toast.LENGTH_LONG).show();
                }
    ...
    class UpdateUIAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                inventoryAdapter = new ExpandableListAdapter(PickupMoveActivity.this, expandableTitleList, expandableDetailList);
