...
public class RNDActivity extends AppCompatActivity {
    ...
    private static final String TAG = RNDActivity.class.getSimpleName();
    ...
    private RNDActivity.SoundTask mSoundTask;
    ...
    private final RNDActivity.BarcodeHandler mBarcodeHandler = new RNDActivity.BarcodeHandler(this);
    ...
    RNDActivity.ProcessEPCAndUpdateUIAsyncTask processEPCAndUpdateUIAsyncTask;
...
"30361FAF541C59800000003E",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_r_n_d);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        pref = getApplicationContext().getSharedPreferences(Constants.PREFS_NAME, MODE_PRIVATE);
        dbManager = new DBManager(RNDActivity.this);
        dbManager.open();
        dbManager.turcateStockTakeChecksum();

        pDialog = new ProgressDialog(RNDActivity.this);

        sessionId = Constants.getSessionId(RNDActivity.this);
        isSessionNew = Constants.isSessionNew(RNDActivity.this);
        ...
        selectedBarcodeList =  Constants.getArrayList(Constants.CATEGORY_ARRAY_JSON, RNDActivity.this);
        colors= getResources().getIntArray(R.array.colors_hex_code);

        if(Constants.isNetworkAvailable(RNDActivity.this)) {
            new RNDActivity.LoadTreeAsyncTask(RNDActivity.this).execute(Constants.DOMAIN_URL+"product_tree_by_barcode.php");
        }
        else
        {
            Constants.internetAlert(RNDActivity.this);
        }
        ...
        collapseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new RNDActivity.ExpandCollapseAllAsyncTask(RNDActivity.this,false).execute();
            }
        });
        ...
        expandButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new RNDActivity.ExpandCollapseAllAsyncTask(RNDActivity.this,true).execute();
            }
        });
            ...
            public void onClick(View view) {
                ...
                if (!mInventory) {
                    ...
                    if (ret == SDConsts.RFResult.SUCCESS) {
                        ...
                        Toast.makeText(RNDActivity.this, "Start Inventory failed, Please check RFR900 MODE", Toast.LENGTH_SHORT).show();
                    else if (ret == SDConsts.RFResult.LOW_BATTERY)
                        Toast.makeText(RNDActivity.this, "Start Inventory failed, LOW_BATTERY", Toast.LENGTH_SHORT).show();
                    else
                ...
                alertDialogBuilder
                        ...
                        .setPositiveButton("Abandon Scan", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if(Constants.isNetworkAvailable(RNDActivity.this)) {
                                    new RNDActivity.RollbackStockTakeAsyncTask(RNDActivity.this).execute(Constants.BASE_URL+"RollBackStockTake.php");
                                }
                                else
                                {
                                    Constants.internetAlert(RNDActivity.this);
                                ...
                                if (ret == SDConsts.RFResult.SUCCESS || ret == SDConsts.RFResult.NOT_INVENTORY_STATE) {
                                    ...
                                    Toast.makeText(RNDActivity.this, "Stop Inventory failed", Toast.LENGTH_SHORT).show();
                        ...
                        .setNegativeButton("Submit Stock Take", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (ret == SDConsts.RFResult.SUCCESS || ret == SDConsts.RFResult.NOT_INVENTORY_STATE) {
                                    ...
                                    if(Constants.isNetworkAvailable(RNDActivity.this)) {
                                        new ServerUpdateAsyncTask().execute(Constants.BASE_URL + "UpdateStockTake.php");
                                    }
                                    else
                                    {
                                        Constants.internetAlert(RNDActivity.this);
                ...
                if(isLast){
                    tv.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Toast.makeText(RNDActivity.this, "Clicked on: "+Title, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
    ...
    private void SoundLoadListener() {
        if (mSoundPool != null) {
            ...
            mSoundId = mSoundPool.load(RNDActivity.this, R.raw.beep, 1);
        }
    }
    ...
    private static class BarcodeHandler extends Handler {
        private final WeakReference<RNDActivity> mExecutor;
        public BarcodeHandler(RNDActivity f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            RNDActivity executor = mExecutor.get();
            if (executor != null) {
            ...
            case SDConsts.Msg.SDMsg:
                switch(m.arg1) {
                    ...
                    case SDConsts.SDCmdMsg.SLED_INVENTORY_STATE_CHANGED:
                        ...
                        Toast.makeText(RNDActivity.this, "Inventory Stopped reason : " + m.arg2, Toast.LENGTH_SHORT).show();
                    ...
                    case SDConsts.SDCmdMsg.SLED_BATTERY_STATE_CHANGED:
                        //Toast.makeText(RNDActivity.this, "Battery state = " + m.arg2, Toast.LENGTH_SHORT).show();
                    ...
                    case SDConsts.SDCmdMsg.SLED_HOTSWAP_STATE_CHANGED:
                        if (m.arg2 == SDConsts.SDHotswapState.HOTSWAP_STATE)
                            Toast.makeText(RNDActivity.this, "HOTSWAP STATE CHANGED = HOTSWAP_STATE", Toast.LENGTH_SHORT).show();
                        else if (m.arg2 == SDConsts.SDHotswapState.NORMAL_STATE)
                            Toast.makeText(RNDActivity.this, "HOTSWAP STATE CHANGED = NORMAL_STATE", Toast.LENGTH_SHORT).show();
                                ...
                                if (data != null && isFinsihButtonPressed == 0)
                                {
                                    if (data.contains(";")) {
                                       ...
                                       if( uniqueEPCList.addIfAbsent(EPCNumber))
                                       {
                                        ...
                                        if (mSoundTask == null) {
                                            mSoundTask = new RNDActivity.SoundTask();
                                            mSoundTask.execute();
                                        }
                                        else {
                                        ...
                                        if(scanFinished == 0)
                                        {
                                            ...
                                            processEPCAndUpdateUIAsyncTask = new RNDActivity.ProcessEPCAndUpdateUIAsyncTask();
                                            processEPCAndUpdateUIAsyncTask.execute();
                                        }
                                    }
                                }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        switch (item.getItemId())
        {
            ...
            case R.id.sound: //Your task
                Intent intent2 = new Intent(RNDActivity.this, SoundManagerActivity.class);
                startActivity(intent2);

                return true;

            case R.id.bluetooth_reader: //Your task
                Intent intent3 = new Intent(RNDActivity.this, InventoryStockTakeAActivity.class);
    ...
    private void showMessageDialog()
    {
        try {
            if (isFinsihButtonPressed == 1) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(RNDActivity.this);
            ...
            dialog.setTitle(title)
                    ...
                    .setPositiveButton("Bluetooth Settings", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialoginterface, int i) {
                            ...
                            Intent intent = new Intent(RNDActivity.this, BTConnectivityActivity.class);
...
//          }})
    ...
    class ServerUpdateAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                Intent intent = new Intent(RNDActivity.this , SerialStockTakeASummaryActivity.class);
    ...
    class RollbackStockTakeAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try
            {
                ...
                Toast.makeText(RNDActivity.this, "Scan Aborted Successfully", Toast.LENGTH_LONG).show();
            }catch(Exception e)
            {
                e.printStackTrace();;
            }
