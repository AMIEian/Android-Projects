...
public class DataImporterMovementActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbManager = new DBManager(DataImporterMovementActivity.this);
        dbManager.open();
        //important to set category level to 1
        Constants.CATEGORY_LEVEL=0;

        if(Constants.isNetworkAvailable(DataImporterMovementActivity.this)) {
            new DataImporterMovementActivity.SQLiteTableDataAsyncTask(DataImporterMovementActivity.this).execute(Constants.BASE_URL + "GetProductStockTagsmartEPCTableData.php");
        }
        else
        {
            Constants.internetAlert(DataImporterMovementActivity.this);
        }
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                try
                {
                    ...
                    Intent intent = new Intent(DataImporterMovementActivity.this , MovementDashboardActivity.class);
                    ...
                    Toast.makeText(DataImporterMovementActivity.this, "Something went wrong. Please try again", Toast.LENGTH_LONG).show();
                    finish();
                }
