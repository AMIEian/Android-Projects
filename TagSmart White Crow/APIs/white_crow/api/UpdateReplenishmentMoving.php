		...
		if(pg_num_rows($reut) > 0)
		{
			...
			else
			{
				while($row= pg_fetch_assoc($resx))   
				{
					...
					{
						$result2 = pg_query($db,"INSERT INTO  stray_epc (stray_id, epc, barcode, stray_date, stray_time, task_id) VALUES(DEFAULT,'$item2','$ean','$stock_date','$stock_time','4')"  );
					}
