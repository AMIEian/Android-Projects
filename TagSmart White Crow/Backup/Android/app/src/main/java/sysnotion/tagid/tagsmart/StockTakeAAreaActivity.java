...
public class StockTakeAAreaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stock_take_a_area);
        ...
        if(Constants.isNetworkAvailable(StockTakeAAreaActivity.this)) {
            new StockTakeAAreaActivity.StoreLocationDataAsyncTask(StockTakeAAreaActivity.this).execute(Constants.BASE_URL + "GetStoreLocation.php");
        }
        else
        {
            Constants.internetAlert(StockTakeAAreaActivity.this);
        }
            ...
            if (result != null) {
                try
                {
                    ...
                    for(int loc =0 ; loc< locationJArray.length(); loc++)
                    {
                        ...
                        Button button=new Button(StockTakeAAreaActivity.this);
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            public void onClick(View view) {
                                ...
                                try {
                                    ...
                                    Intent intent = new Intent(StockTakeAAreaActivity.this , StockTakeOptionACategoryActivity.class);
                    ...
                    Toast.makeText(StockTakeAAreaActivity.this, "Something went wrong. Please try again", Toast.LENGTH_LONG).show();
                    finish();
                }
