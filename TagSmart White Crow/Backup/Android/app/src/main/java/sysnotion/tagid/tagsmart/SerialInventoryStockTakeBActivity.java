...
public class SerialInventoryStockTakeBActivity extends AppCompatActivity {

    private static final String TAG = SerialInventoryStockTakeBActivity.class.getSimpleName();
    ...
    SerialInventoryStockTakeBActivity.ProcessEPCAndUpdateUIAsyncTask processEPCAndUpdateUIAsyncTask;
...
"30361FAF541C59800000003E",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbManager = new DBManager(SerialInventoryStockTakeBActivity.this);
        dbManager.open();
        dbManager.turcateStockTakeChecksum();

        pDialog = new ProgressDialog(SerialInventoryStockTakeBActivity.this);

        sessionId = Constants.getSessionId(SerialInventoryStockTakeBActivity.this);
        isSessionNew = "-1";
        ...
        selectedBarcodeList =  Constants.getArrayList(Constants.CATEGORY_ARRAY_JSON, SerialInventoryStockTakeBActivity.this);
        Log.d("plan stock take","selectedBarcodeList "+selectedBarcodeList);
        colors= getResources().getIntArray(R.array.colors_hex_code);

        if(Constants.isNetworkAvailable(SerialInventoryStockTakeBActivity.this)) {
            new SerialInventoryStockTakeBActivity.LoadTreeAsyncTask(SerialInventoryStockTakeBActivity.this).execute(Constants.DOMAIN_URL+"product_tree_by_barcode.php");
        }
        else
        {
            Constants.internetAlert(SerialInventoryStockTakeBActivity.this);
        }
        ...
        collapseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new SerialInventoryStockTakeBActivity.ExpandCollapseAllAsyncTask(SerialInventoryStockTakeBActivity.this,false).execute();
            }
        });
        ...
        expandButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new SerialInventoryStockTakeBActivity.ExpandCollapseAllAsyncTask(SerialInventoryStockTakeBActivity.this,true).execute();
            }
        });
            ...
            public void onClick(View view) {
                ...
                if (!mInventory) {
                    ...
                    if (ret == SDConsts.RFResult.SUCCESS) {
                        ...
                        Toast.makeText(SerialInventoryStockTakeBActivity.this, "Start Inventory failed, Please check RFR900 MODE", Toast.LENGTH_SHORT).show();
                    else if (ret == SDConsts.RFResult.LOW_BATTERY)
                        Toast.makeText(SerialInventoryStockTakeBActivity.this, "Start Inventory failed, LOW_BATTERY", Toast.LENGTH_SHORT).show();
                    else
        ...
        finishScanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                        SerialInventoryStockTakeBActivity.this);
                ...
                alertDialogBuilder
                        ...
                        .setPositiveButton("Abandon Scan", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if(Constants.isNetworkAvailable(SerialInventoryStockTakeBActivity.this)) {
                                    new SerialInventoryStockTakeBActivity.RollbackStockTakeAsyncTask(SerialInventoryStockTakeBActivity.this).execute(Constants.BASE_URL+"RollBackStockTake.php");
                                }
                                else
                                {
                                    Constants.internetAlert(SerialInventoryStockTakeBActivity.this);
                                ...
                                if (ret == SDConsts.RFResult.SUCCESS || ret == SDConsts.RFResult.NOT_INVENTORY_STATE) {
                                    ...
                                    Toast.makeText(SerialInventoryStockTakeBActivity.this, "Stop Inventory failed", Toast.LENGTH_SHORT).show();
                        ...
                        .setNegativeButton("Submit Stock Take", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (ret == SDConsts.RFResult.SUCCESS || ret == SDConsts.RFResult.NOT_INVENTORY_STATE) {
                                    ...
                                    if(Constants.isNetworkAvailable(SerialInventoryStockTakeBActivity.this)) {
                                        new SerialInventoryStockTakeBActivity.ServerUpdateAsyncTask().execute(Constants.BASE_URL + "UpdateStockTake.php");
                                    }
                                    else
                                    {
                                        Constants.internetAlert(SerialInventoryStockTakeBActivity.this);
                ...
                if(isLast){
                    tv.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Toast.makeText(SerialInventoryStockTakeBActivity.this, "Clicked on: "+Title, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
    ...
    private void SoundLoadListener() {
        if (mSoundPool != null) {
            ...
            mSoundId = mSoundPool.load(SerialInventoryStockTakeBActivity.this, R.raw.beep, 1);
        }
    }
    ...
    private static class BarcodeHandler extends Handler {
        private final WeakReference<SerialInventoryStockTakeBActivity> mExecutor;
        public BarcodeHandler(SerialInventoryStockTakeBActivity f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            SerialInventoryStockTakeBActivity executor = mExecutor.get();
            if (executor != null) {
            ...
            case SDConsts.Msg.SDMsg:
                switch(m.arg1) {
                    ...
                    case SDConsts.SDCmdMsg.SLED_BATTERY_STATE_CHANGED:
                        //Toast.makeText(SerialInventoryStockTakeBActivity.this, "Battery state = " + m.arg2, Toast.LENGTH_SHORT).show();
                    ...
                    case SDConsts.SDCmdMsg.SLED_HOTSWAP_STATE_CHANGED:
                        if (m.arg2 == SDConsts.SDHotswapState.HOTSWAP_STATE)
                            Toast.makeText(SerialInventoryStockTakeBActivity.this, "HOTSWAP STATE CHANGED = HOTSWAP_STATE", Toast.LENGTH_SHORT).show();
                        else if (m.arg2 == SDConsts.SDHotswapState.NORMAL_STATE)
                            Toast.makeText(SerialInventoryStockTakeBActivity.this, "HOTSWAP STATE CHANGED = NORMAL_STATE", Toast.LENGTH_SHORT).show();
                            ...
                            try {
                                if (m.obj != null && m.obj instanceof String) {
                                    ...
                                    if (data != null && isFinsihButtonPressed == 0) {
                                        if (data.contains(";")) {
                                            //full tag example(withoptional value)
...
//System.out.println("ProcessEPCAndUpdateUIAsyncTask position " +position);
                                            ...
                                            if (mSoundTask == null) {
                                                mSoundTask = new
                                                        SerialInventoryStockTakeBActivity.SoundTask();
                                                mSoundTask.execute();
                                            } else {
                                                if
                                                (mSoundTask.getStatus() == AsyncTask.Status.FINISHED) {
                                ...
                                Toast.makeText(getBaseContext(), "Reader Scan value: " + (String) m.obj + " " + exceptionAsString,
                                Toast.LENGTH_SHORT).show();
                                if
                                (Constants.isNetworkAvailable(SerialInventoryStockTakeBActivity.this)) {
                                    new AppCrashLogsAsyncTask("Reader Scan value: " + (String) m.obj + " " +
                                    exceptionAsString).execute(Constants.BASE_URL + "AppLogs.php");
                                }
                            }
                        }
                        break;
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        switch (item.getItemId())
        {
            ...
            case R.id.sound: //Your task
                Intent intent2 = new Intent(SerialInventoryStockTakeBActivity.this, SoundManagerActivity.class);
                startActivity(intent2);

                return true;

            case R.id.bluetooth_reader: //Your task
                Intent intent3 = new Intent(SerialInventoryStockTakeBActivity.this, InventoryStockTakeBActivity.class);
    ...
    private void showMessageDialog()
    {
        try {
            if (isFinsihButtonPressed == 1) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(SerialInventoryStockTakeBActivity.this);
            ...
            dialog.setTitle(title)
                    ...
                    .setPositiveButton("Bluetooth Settings", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialoginterface, int i) {
                            ...
                            Intent intent = new Intent(SerialInventoryStockTakeBActivity.this, BTConnectivityActivity.class);
...
//          }})
    ...
    class LoadTreeAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
           ...
           /* Date d2 = new Date();
            ...
            if (Constants.isNetworkAvailable(SerialInventoryStockTakeBActivity.this))
            {
                new FetchBarcodeAndEPCAsyncTask(SerialInventoryStockTakeBActivity.this).execute(Constants.BASE_URL + "Get_Ethnicity_Bar_EPC_Data.php");
    ...
    class ServerUpdateAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            super.onPostExecute(result);
            dismissProgressDialog();
            Toast.makeText(SerialInventoryStockTakeBActivity.this, "Stock take data uploaded successfully", Toast.LENGTH_LONG).show();
            finish();
            //System.out.println("ServerUpdateUIAsyncTask Resp " + result);
            /*System.out.println("currentTimeMillis after " + System.currentTimeMillis());*/

           /* try {
                Intent intent = new Intent(SerialInventoryStockTakeBActivity.this , SerialStockTakeASummaryActivity.class);
    ...
    class RollbackStockTakeAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try
            {
                ...
                Toast.makeText(SerialInventoryStockTakeBActivity.this, "Scan Aborted Successfully", Toast.LENGTH_LONG).show();
            }catch(Exception e)
            {
                e.printStackTrace();;
            }
