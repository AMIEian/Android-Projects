...
public class LocationScanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pDialog = new ProgressDialog(LocationScanActivity.this);
        ...
        if (Constants.isNetworkAvailable(LocationScanActivity.this)) {
            new  FetchBarcodeAndEPCAsyncTask(LocationScanActivity.this).execute(Constants.BASE_URL + "GetEPCBarcodeMasterData.php");

        } else {
            Constants.internetAlert(LocationScanActivity.this);
