...
public class SerialProcessInwardDataActivity extends AppCompatActivity {

    private static final String TAG = SerialProcessInwardDataActivity.class.getSimpleName();
    ...
    private SerialProcessInwardDataActivity.SoundTask mSoundTask;
    ...
    private final SerialProcessInwardDataActivity.BarcodeHandler mBarcodeHandler = new SerialProcessInwardDataActivity.BarcodeHandler(this);
    ...
    SerialProcessInwardDataActivity.ProcessEPCAndUpdateUIAsyncTask processEPCAndUpdateUIAsyncTask;
...
"E2801170200014FEDF6109EF"
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbManager = new DBManager(SerialProcessInwardDataActivity.this);
        dbManager.open();
        dbManager.turcateStockTakeChecksum();
        pDialog = new ProgressDialog(SerialProcessInwardDataActivity.this);

        sessionId = Constants.getSessionId(SerialProcessInwardDataActivity.this);
        isSessionNew = Constants.isSessionNew(SerialProcessInwardDataActivity.this);
        ...
        selectedBarcodeList =  Constants.getArrayList(Constants.CATEGORY_ARRAY_JSON, SerialProcessInwardDataActivity.this);
        colors= getResources().getIntArray(R.array.colors_hex_code);

        if(Constants.isNetworkAvailable(SerialProcessInwardDataActivity.this)) {
            new SerialProcessInwardDataActivity.LoadTreeAsyncTask(SerialProcessInwardDataActivity.this).execute(Constants.DOMAIN_URL+"product_tree_inwarding_by_barcode.php");
        }
        else
        {
            Constants.internetAlert(SerialProcessInwardDataActivity.this);
        }
        ...
        collapseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new SerialProcessInwardDataActivity.ExpandCollapseAllAsyncTask(SerialProcessInwardDataActivity.this,false).execute();
            }
        });
        ...
        expandButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new SerialProcessInwardDataActivity.ExpandCollapseAllAsyncTask(SerialProcessInwardDataActivity.this,true).execute();
            }
        });
            ...
            public void onClick(View view) {
                ...
                if (!mInventory) {
                    ...
                    if (ret == SDConsts.RFResult.SUCCESS) {
                        ...
                        Toast.makeText(SerialProcessInwardDataActivity.this, "Start Inventory failed, Please check RFR900 MODE", Toast.LENGTH_SHORT).show();
                    else if (ret == SDConsts.RFResult.LOW_BATTERY)
                        Toast.makeText(SerialProcessInwardDataActivity.this, "Start Inventory failed, LOW_BATTERY", Toast.LENGTH_SHORT).show();
                    else
        ...
        finishScanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                        SerialProcessInwardDataActivity.this);
                        ...
                        .setPositiveButton("Submit Stock Take", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (ret == SDConsts.RFResult.SUCCESS || ret == SDConsts.RFResult.NOT_INVENTORY_STATE) {
                                    ...
                                    if(Constants.isNetworkAvailable(SerialProcessInwardDataActivity.this)) {
                                        new  ServerUpdateAsyncTask().execute(Constants.BASE_URL + "UpdateInwardData.php");
                                    }
                                    else
                                    {
                                        Constants.internetAlert(SerialProcessInwardDataActivity.this);
                                    ...
                                    Toast.makeText(SerialProcessInwardDataActivity.this, "Stop Inventory failed", Toast.LENGTH_SHORT).show();
                ...
                if(isLast){
                    tv.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Toast.makeText(SerialProcessInwardDataActivity.this, "Clicked on: "+Title, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
    ...
    private void SoundLoadListener() {
        if (mSoundPool != null) {
            ...
            mSoundId = mSoundPool.load(SerialProcessInwardDataActivity.this, R.raw.beep, 1);
        }
    }
    ...
    private static class BarcodeHandler extends Handler {
        private final WeakReference<SerialProcessInwardDataActivity> mExecutor;
        public BarcodeHandler(SerialProcessInwardDataActivity f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            SerialProcessInwardDataActivity executor = mExecutor.get();
            if (executor != null) {
            ...
            case SDConsts.Msg.SDMsg:
                switch(m.arg1) {
                    ...
                    case SDConsts.SDCmdMsg.SLED_BATTERY_STATE_CHANGED:
                        //Toast.makeText(SerialProcessInwardDataActivity.this, "Battery state = " + m.arg2, Toast.LENGTH_SHORT).show();
                    ...
                    case SDConsts.SDCmdMsg.SLED_HOTSWAP_STATE_CHANGED:
                        if (m.arg2 == SDConsts.SDHotswapState.HOTSWAP_STATE)
                            Toast.makeText(SerialProcessInwardDataActivity.this, "HOTSWAP STATE CHANGED = HOTSWAP_STATE", Toast.LENGTH_SHORT).show();
                        else if (m.arg2 == SDConsts.SDHotswapState.NORMAL_STATE)
                            Toast.makeText(SerialProcessInwardDataActivity.this, "HOTSWAP STATE CHANGED = NORMAL_STATE", Toast.LENGTH_SHORT).show();
                                ...
                                if (m.obj != null && m.obj instanceof String) {
                                    ...
                                    if (data != null && isFinsihButtonPressed == 0) {
                                        ...
                                        ////// test over*/
                                            ...
                                            if (mSoundTask == null) {
                                                mSoundTask = new SerialProcessInwardDataActivity.SoundTask();
                                                mSoundTask.execute();
                                            } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        switch (item.getItemId())
        {
            ...
            case R.id.sound: //Your task
                Intent intent2 = new Intent(SerialProcessInwardDataActivity.this, SoundManagerActivity.class);
                startActivity(intent2);

                return true;

            case R.id.bluetooth_reader: //Your task
                Intent intent3 = new Intent(SerialProcessInwardDataActivity.this, ProcessInwardDataActivity.class);
    ...
    private void showMessageDialog()
    {
        try {
            if (isFinsihButtonPressed == 1) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(SerialProcessInwardDataActivity.this);
            ...
            dialog.setTitle(title)
                    ...
                    .setPositiveButton("Bluetooth Settings", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialoginterface, int i) {
                            ...
                            Intent intent = new Intent(SerialProcessInwardDataActivity.this, BTConnectivityActivity.class);
...
//          }})
    ...
    class LoadTreeAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
           ...
           /* Date d2 = new Date();
            ...
            if (Constants.isNetworkAvailable(SerialProcessInwardDataActivity.this)) {
                new  FetchBarcodeAndEPCAsyncTask(SerialProcessInwardDataActivity.this).execute(Constants.BASE_URL + "Get_Ethnicity_Bar_EPC_Data.php");
    ...
    class ServerUpdateAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                Intent intent = new Intent(SerialProcessInwardDataActivity.this , InwardStockSummaryActivity.class);
