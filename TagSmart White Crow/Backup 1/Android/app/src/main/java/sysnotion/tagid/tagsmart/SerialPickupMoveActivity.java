...
public class SerialPickupMoveActivity extends AppCompatActivity {

    private static final String TAG = SerialPickupMoveActivity.class.getSimpleName();
    ...
    private SerialPickupMoveActivity.SoundTask mSoundTask;
    ...
    private final SerialPickupMoveActivity.BarcodeHandler mBarcodeHandler = new SerialPickupMoveActivity.BarcodeHandler(this);
    ...
    SerialPickupMoveActivity.ProcessEPCAndUpdateUIAsyncTask processEPCAndUpdateUIAsyncTask;
    JSONArray barcodePositionArray = new JSONArray();
    private ProgressDialog pDialog;
    SerialPickupMoveActivity.UpdateUIAsyncTask updateUIAsyncTask;
    int UIJSONLength=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_serial_pickup_move);
        ...
        selectedEPCList =  Constants.getArrayList(Constants.CATEGORY_ARRAY_JSON, SerialPickupMoveActivity.this);
        ...
        location_id="3"; //shop
        sublocation_id="3"; //back store

        pDialog = new ProgressDialog(SerialPickupMoveActivity.this);

        sessionId = Constants.PICKUP_SESSION;
        isSessionNew = "-1";
        ...
        collapseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // new  ExpandCollapseAllAsyncTask(SerialPickupMoveActivity.this,false).execute();
        ...
        expandButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // new  ExpandCollapseAllAsyncTask(SerialPickupMoveActivity.this,true).execute();
                for(int i=0; i < inventoryAdapter.getGroupCount(); i++)
            ...
            public void onClick(View view) {
                ...
                if (!mInventory) {
                    ...
                    if (ret == SDConsts.RFResult.SUCCESS) {
                                ...
                                handler.post(new Runnable() {
                                    public void run() {
                                        if(scanFinished == 0)
                                        {
                                            ...
                                            processEPCAndUpdateUIAsyncTask = new SerialPickupMoveActivity.ProcessEPCAndUpdateUIAsyncTask();
                                            processEPCAndUpdateUIAsyncTask.execute(Constants.BASE_URL + "UpdatePickupMoving.php");
                                        }
                                ...
                                handler2.post(new Runnable() {
                                    public void run() {
                                        if(uiUpdateFinished == 0)
                                        {
                                            ...
                                            updateUIAsyncTask = new SerialPickupMoveActivity.UpdateUIAsyncTask();
                        ...
                        Toast.makeText(SerialPickupMoveActivity.this, "Start Inventory failed, Please check RFR900 MODE", Toast.LENGTH_SHORT).show();
                    else if (ret == SDConsts.RFResult.LOW_BATTERY)
                        Toast.makeText(SerialPickupMoveActivity.this, "Start Inventory failed, LOW_BATTERY", Toast.LENGTH_SHORT).show();
                    else
                        ...
                        .setNegativeButton("Submit Stock Scan", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (ret == SDConsts.RFResult.SUCCESS || ret == SDConsts.RFResult.NOT_INVENTORY_STATE) {
                                    ...
                                    Toast.makeText(SerialPickupMoveActivity.this, "Stop Inventory failed", Toast.LENGTH_SHORT).show();
    ...
    private void SoundLoadListener() {
        if (mSoundPool != null) {
            ...
            mSoundId = mSoundPool.load(SerialPickupMoveActivity.this, R.raw.beep, 1);
        }
    }
    ...
    private static class BarcodeHandler extends Handler {
        private final WeakReference<SerialPickupMoveActivity> mExecutor;
        public BarcodeHandler(SerialPickupMoveActivity f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            SerialPickupMoveActivity executor = mExecutor.get();
            if (executor != null) {
            ...
            case SDConsts.Msg.SDMsg:
                switch(m.arg1) {
                    ...
                    case SDConsts.SDCmdMsg.SLED_INVENTORY_STATE_CHANGED:
                        ...
                        Toast.makeText(SerialPickupMoveActivity.this, "Inventory Stopped reason : " + m.arg2, Toast.LENGTH_SHORT).show();
                    ...
                    case SDConsts.SDCmdMsg.SLED_BATTERY_STATE_CHANGED:
                        //Toast.makeText(SerialPickupMoveActivity.this, "Battery state = " + m.arg2, Toast.LENGTH_SHORT).show();
                    ...
                    case SDConsts.SDCmdMsg.SLED_HOTSWAP_STATE_CHANGED:
                        if (m.arg2 == SDConsts.SDHotswapState.HOTSWAP_STATE)
                            Toast.makeText(SerialPickupMoveActivity.this, "HOTSWAP STATE CHANGED = HOTSWAP_STATE", Toast.LENGTH_SHORT).show();
                        else if (m.arg2 == SDConsts.SDHotswapState.NORMAL_STATE)
                            Toast.makeText(SerialPickupMoveActivity.this, "HOTSWAP STATE CHANGED = NORMAL_STATE", Toast.LENGTH_SHORT).show();
                            ...
                            if (m.obj != null  && m.obj instanceof String) {
                                ...
                                if (data != null && isFinsihButtonPressed == 0)
                                {
                                    if (data.contains(";")) {
                                        ...
                                        if (mSoundTask == null) {
                                            mSoundTask = new SerialPickupMoveActivity.SoundTask();
                                            mSoundTask.execute();
                                        }
                                        else {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        switch (item.getItemId())
        {
            ...
            case R.id.sound: //Your task
                Intent intent2 = new Intent(SerialPickupMoveActivity.this, SoundManagerActivity.class);
                startActivity(intent2);
                return true;

            case R.id.bluetooth_reader:
                Intent intent3 = new Intent(SerialPickupMoveActivity.this, PickupMoveActivity.class);
    ...
    private void showMessageDialog()
    {
        try {
            if (isFinsihButtonPressed == 1) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(SerialPickupMoveActivity.this);
            ...
            dialog.setTitle(title)
                    ...
                    .setPositiveButton("Bluetooth Settings", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialoginterface, int i) {
                            ...
                            Intent intent = new Intent(SerialPickupMoveActivity.this, BTConnectivityActivity.class);
    ...
    class ProcessEPCAndUpdateUIAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                {
                    Toast.makeText(SerialPickupMoveActivity.this, "Something went wrong during updating epc to server", Toast.LENGTH_LONG).show();
                }
    ...
    class UpdateUIAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                inventoryAdapter = new ExpandableListAdapter(SerialPickupMoveActivity.this, expandableTitleList, expandableDetailList);
