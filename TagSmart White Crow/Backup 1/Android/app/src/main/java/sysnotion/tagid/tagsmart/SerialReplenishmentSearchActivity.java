...
public class SerialReplenishmentSearchActivity extends AppCompatActivity {
    private static final String TAG = SerialReplenishmentSearchActivity.class.getSimpleName();
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_serial_replenishment_search);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        pref = getApplicationContext().getSharedPreferences(Constants.PREFS_NAME, MODE_PRIVATE);
        selectedBarcodeList =  Constants.getArrayList(Constants.CATEGORY_ARRAY_JSON, SerialReplenishmentSearchActivity.this);
        ...
        pDialog = new ProgressDialog(SerialReplenishmentSearchActivity.this);

        if(Constants.isNetworkAvailable(SerialReplenishmentSearchActivity.this)) {
            new  FetchBarcodeListAsyncTask(SerialReplenishmentSearchActivity.this).execute(Constants.BASE_URL+"GetReplenishmentByBarcode.php");
        }
        else
        {
            Constants.internetAlert(SerialReplenishmentSearchActivity.this);
        }
        ...
        nextMoveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(selectedEPCList.size() > 0)
                {
                    ...
                    Constants.saveArrayList(mArrayProducts,Constants.CATEGORY_ARRAY_JSON, SerialReplenishmentSearchActivity.this);

                    Intent intent = new Intent(SerialReplenishmentSearchActivity.this , SerialReplenishmentMoveActivity.class);
                    startActivity(intent);
                    finish();
                }
                else
                {
                    Toast.makeText(SerialReplenishmentSearchActivity.this, "No EPC searched. Click on the row to search the barcode and asscoiated EPC's", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void SoundLoadListener() {
        if (mSoundPool != null) {
            ...
            mSoundId = mSoundPool.load(SerialReplenishmentSearchActivity.this, R.raw.beep, 1);
        }
    }
    ...
    {
        try {
            AlertDialog.Builder dialog = new AlertDialog.Builder(SerialReplenishmentSearchActivity.this);
...
//          }})
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case R.id.sound: //Your task
                Intent intent2 = new Intent(SerialReplenishmentSearchActivity.this, SoundManagerActivity.class);
                startActivity(intent2);
                return true;

            case R.id.bluetooth_reader: //Your task
                Intent intent3 = new Intent(SerialReplenishmentSearchActivity.this, ReplenishmentSearchActivity.class);
    ...
    private static class BarcodeHandler extends Handler {
        private final WeakReference<SerialReplenishmentSearchActivity> mExecutor;
        public BarcodeHandler(SerialReplenishmentSearchActivity f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            SerialReplenishmentSearchActivity executor = mExecutor.get();
            if (executor != null) {
            ...
            case SDConsts.Msg.SDMsg:
                switch(m.arg1) {
                    ...
                    case SDConsts.SDCmdMsg.SLED_INVENTORY_STATE_CHANGED:
                        ...
                        Toast.makeText(SerialReplenishmentSearchActivity.this, "Inventory Stopped reason : " + m.arg2, Toast.LENGTH_SHORT).show();
                        break;
                    ...
                    case SDConsts.SDCmdMsg.SLED_HOTSWAP_STATE_CHANGED:
                        if (m.arg2 == SDConsts.SDHotswapState.HOTSWAP_STATE)
                            Toast.makeText(SerialReplenishmentSearchActivity.this, "HOTSWAP STATE CHANGED = HOTSWAP_STATE", Toast.LENGTH_SHORT).show();
                        else if (m.arg2 == SDConsts.SDHotswapState.NORMAL_STATE)
                            Toast.makeText(SerialReplenishmentSearchActivity.this, "HOTSWAP STATE CHANGED = NORMAL_STATE", Toast.LENGTH_SHORT).show();
    ...
    public void showPopupWindowClick(View view,final  int index) {
        ...
        try {
            ...
            for(int k=0; k <lepcArray.length(); k++)
            {
                ...
                if(tempObj.getString("sub_location_id").compareToIgnoreCase("3") == 0)
                {
                   ...
                   // Log.d(TAG, "tempepcList " + tempepcList);
                    break;
                }
            }
        }catch(Exception e)
        ...
        startScanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ret == SDConsts.RFResult.SUCCESS) {
                    ...
                    Toast.makeText(SerialReplenishmentSearchActivity.this, "Scan failed, Please check RFR900 MODE", Toast.LENGTH_SHORT).show();
                else if (ret == SDConsts.RFResult.LOW_BATTERY)
                    Toast.makeText(SerialReplenishmentSearchActivity.this, "Scan   failed, LOW_BATTERY", Toast.LENGTH_SHORT).show();
                else
        ...
        stopScanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ret == SDConsts.RFResult.SUCCESS || ret == SDConsts.RFResult.NOT_INVENTORY_STATE) {
                    ...
                    Toast.makeText(SerialReplenishmentSearchActivity.this, "Stop Inventory failed", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onClick(View view) {
                ...
                if(adapter != null) {
                    ...
                    if(mArrayProducts.size()> 0)
                    {
                        ...
                        TableRow row = (TableRow) mainTable.getChildAt(tableRowIndex);
                    ...
                    {
                        Toast.makeText(SerialReplenishmentSearchActivity.this, "No EPC's are selected", Toast.LENGTH_SHORT).show();
                    }
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null)
            {
                try {
                    ...
                    TableRow tableRow = new TableRow(SerialReplenishmentSearchActivity.this);
                    ...
                    for (int j = 0; j < anchorIndex; j++)
                    {   /* create cell element - textview */
                        TextView tv = new TextView(SerialReplenishmentSearchActivity.this);
                    ...
                    keyList.add("barcode");
                    NUMBER_OF_COLUMNS++;
                    keyList.add("replenishment_quantity");
                    NUMBER_OF_COLUMNS++;
                    ...
                    /* add views to the row */
                    tableRow.addView(tv);
                    TextView tv2 = new TextView(SerialReplenishmentSearchActivity.this);
                    tv2.setBackgroundResource(R.drawable.table_header_bg);
                    tv2.setText("Replenishment Qty");
                    ...
                    TextView tv3 = new TextView(SerialReplenishmentSearchActivity.this);
                    ...
                    TextView tv4 = new TextView(SerialReplenishmentSearchActivity.this);
                    tv4.setBackgroundResource(R.drawable.table_header_bg);
                    tv4.setText("Found Qty");
                    ...
                    for (int j = 0; j < barcodeDetailsArray.length(); j++)
                    {
                        ...
                        TableRow tableRow2 = new TableRow(SerialReplenishmentSearchActivity.this);
                        ...
                        {
                            //set value of replenishment qty which is replenish qty from DB minus
                            if(i == (keyList.size() -1) )
                            {
                                int arrySize = 0;
                                for(int k=0; k <lepcArray.length(); k++)
                                ...
                                int diff = Integer.parseInt(jobj.getString(keyList.get(i))) - arrySize;
                                TextView tvr = new TextView(SerialReplenishmentSearchActivity.this);
                                tvr.setBackgroundResource(R.drawable.table_row_bg);
                                tvr.setText(diff+"");

                                Log.d("serial repl", " Diff "+diff);

                                if(diff < 1) // check if diff is less than 1
                                {
                                    flag = 1;
                        ...
                        tableRow2. setOnClickListener(new View.OnClickListener()
                        {
                            ...
                            public void onClick(View v)
                            {
                                ...
                                // It's index
                                int index = v.getId();
                                tableRowIndex =  mainTable.indexOfChild(v);

                                Log.d("Index00","Index00   "+index);
                                Log.d("tableRowIndex00","tableRowIndex00   "+tableRowIndex);
                    ...
                    {
                        Toast.makeText(SerialReplenishmentSearchActivity.this, "No Data Found", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        Toast.makeText(SerialReplenishmentSearchActivity.this, "Click on the row to search the barcode and asscoiated EPC's", Toast.LENGTH_SHORT).show();
                    }
                ...
                {
                    e.printStackTrace();
                    Toast.makeText(SerialReplenishmentSearchActivity.this, "Something went wrong. Please try again", Toast.LENGTH_LONG).show();
                }
            }
