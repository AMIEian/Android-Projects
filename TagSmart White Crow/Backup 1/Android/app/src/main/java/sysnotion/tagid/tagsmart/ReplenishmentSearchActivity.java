...
public class ReplenishmentSearchActivity  extends AppCompatActivity {
    private static final String TAG = ReplenishmentSearchActivity.class.getSimpleName();
    ...
    private ReplenishmentSearchActivity.SoundTask mSoundTask;
    //reader
    private BTReader mReader;
    private final ReplenishmentSearchActivity.BarcodeHandler mBarcodeHandler = new ReplenishmentSearchActivity.BarcodeHandler(this);
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedBarcodeList =  Constants.getArrayList(Constants.CATEGORY_ARRAY_JSON, ReplenishmentSearchActivity.this);
        ...
        pDialog = new ProgressDialog(ReplenishmentSearchActivity.this);

        if(Constants.isNetworkAvailable(ReplenishmentSearchActivity.this)) {
            new ReplenishmentSearchActivity.FetchBarcodeListAsyncTask(ReplenishmentSearchActivity.this).execute(Constants.BASE_URL+"GetReplenishmentByBarcode.php");
        }
        else
        {
            Constants.internetAlert(ReplenishmentSearchActivity.this);
        }
        ...
        nextMoveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(selectedEPCList.size() > 0)
                {
                    ...
                    Constants.saveArrayList(mArrayProducts,Constants.CATEGORY_ARRAY_JSON, ReplenishmentSearchActivity.this);

                    Intent intent = new Intent(ReplenishmentSearchActivity.this , ReplenishmentMoveActivity.class);
                    startActivity(intent);
                    finish();
                }
                else
                {
                    Toast.makeText(ReplenishmentSearchActivity.this, "No EPC searched. Click on the row to search the barcode and asscoiated EPC's", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void SoundLoadListener() {
        if (mSoundPool != null) {
            ...
            mSoundId = mSoundPool.load(ReplenishmentSearchActivity.this, R.raw.beep, 1);
        }
    }
    ...
    {
        try {
            AlertDialog.Builder dialog = new AlertDialog.Builder(ReplenishmentSearchActivity.this);
            dialog.setTitle(title)
                    ...
                    .setPositiveButton("Bluetooth Settings", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialoginterface, int i) {
                            ...
                            Intent intent = new Intent(ReplenishmentSearchActivity.this, BTConnectivityActivity.class);
                            startActivity(intent);
                        }
                    }).show();
...
//          }})
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case R.id.sound: //Your task
                Intent intent2 = new Intent(ReplenishmentSearchActivity.this, SoundManagerActivity.class);
            ...
            case R.id.serial_reader: //Your task
                Intent intent3 = new Intent(ReplenishmentSearchActivity.this, SerialReplenishmentSearchActivity.class);
    ...
    private static class BarcodeHandler extends Handler {
        private final WeakReference<ReplenishmentSearchActivity> mExecutor;
        public BarcodeHandler(ReplenishmentSearchActivity f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            ReplenishmentSearchActivity executor = mExecutor.get();
            if (executor != null) {
            ...
            case SDConsts.Msg.SDMsg:
                switch(m.arg1) {
                    ...
                    case SDConsts.SDCmdMsg.SLED_INVENTORY_STATE_CHANGED:
                        ...
                        Toast.makeText(ReplenishmentSearchActivity.this, "Inventory Stopped reason : " + m.arg2, Toast.LENGTH_SHORT).show();
                        break;
                    ...
                    case SDConsts.SDCmdMsg.SLED_HOTSWAP_STATE_CHANGED:
                        if (m.arg2 == SDConsts.SDHotswapState.HOTSWAP_STATE)
                            Toast.makeText(ReplenishmentSearchActivity.this, "HOTSWAP STATE CHANGED = HOTSWAP_STATE", Toast.LENGTH_SHORT).show();
                        else if (m.arg2 == SDConsts.SDHotswapState.NORMAL_STATE)
                            Toast.makeText(ReplenishmentSearchActivity.this, "HOTSWAP STATE CHANGED = NORMAL_STATE", Toast.LENGTH_SHORT).show();
                            ...
                            if (m.obj != null  && m.obj instanceof String) {
                                ...
                                if (data != null)
                                {
                                    ...
                                    if (data.contains(";")) {
                                        ...
                                        if (mSoundTask == null) {
                                            mSoundTask = new ReplenishmentSearchActivity.SoundTask();
                                            mSoundTask.execute();
                                        }
                                        else {
        ...
        startScanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ret == SDConsts.RFResult.SUCCESS) {
                    ...
                    Toast.makeText(ReplenishmentSearchActivity.this, "Scan failed, Please check RFR900 MODE", Toast.LENGTH_SHORT).show();
                else if (ret == SDConsts.RFResult.LOW_BATTERY)
                    Toast.makeText(ReplenishmentSearchActivity.this, "Scan   failed, LOW_BATTERY", Toast.LENGTH_SHORT).show();
                else
        ...
        stopScanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ret == SDConsts.RFResult.SUCCESS || ret == SDConsts.RFResult.NOT_INVENTORY_STATE) {
                    ...
                    Toast.makeText(ReplenishmentSearchActivity.this, "Stop Inventory failed", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        closeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(adapter != null) {
                    ...
                    {
                        Toast.makeText(ReplenishmentSearchActivity.this, "No EPC's are selected", Toast.LENGTH_SHORT).show();
                    }
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null)
            {
                try {
                    ...
                    TableRow tableRow = new TableRow(ReplenishmentSearchActivity.this);
                    ...
                    for (int j = 0; j < anchorIndex; j++) {   /* create cell element - textview */
                        TextView tv = new TextView(ReplenishmentSearchActivity.this);
                    ...
                    /* add views to the row */
                    tableRow.addView(tv);
                    TextView tv2 = new TextView(ReplenishmentSearchActivity.this);
                    ...
                    TextView tv3 = new TextView(ReplenishmentSearchActivity.this);
                    ...
                    TextView tv4 = new TextView(ReplenishmentSearchActivity.this);
                    ...
                    for (int j = 0; j < barcodeDetailsArray.length(); j++) {
                        ...
                        TableRow tableRow2 = new TableRow(ReplenishmentSearchActivity.this);
                        ...
                        for(int i=0; i<keyList.size(); i++ )
                        {
                            ...
                            if(i == (keyList.size() -1) )
                            {
                                ...
                                TextView tvr = new TextView(ReplenishmentSearchActivity.this);
                    ...
                    {
                        Toast.makeText(ReplenishmentSearchActivity.this, "No Data Found", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        Toast.makeText(ReplenishmentSearchActivity.this, "Click on the row to search the barcode and asscoiated EPC's", Toast.LENGTH_SHORT).show();
                    }
                }
                catch(Exception e)
                {
                    e.printStackTrace();
                    Toast.makeText(ReplenishmentSearchActivity.this, "Something went wrong. Please try again", Toast.LENGTH_LONG).show();
                }
            }
