...
public class AboutScreen extends GLScreen {
    ...
    @Override
    public void resume() {
        aboutImage = new Texture(glGame, "about.png" );
        aboutRegion = new TextureRegion(aboutImage, 0, 0, 298, 470);
    }
    ...
    public void present(float deltaTime) {
        ...
        batcher.beginBatch(aboutImage);
        batcher.drawSprite(160, 240, 310, 470, aboutRegion);
        batcher.endBatch();
