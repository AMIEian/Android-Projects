...
public class Productc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.vsi.smart.dairy1.R.layout.activity_productc);
        ...
        tittle.setText("Productwise Search");
        ...
        imgbutton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent=new Intent(Productc.this,Searchr.class);
        ...
        calendarbtn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(Productc.this,
...
//                                Toast.makeText(Birthday.this,pyear+ "-"+pmonth+"-"+pday, Toast.LENGTH_SHORT).show();
    ...
    protected void onResume() {
        ...
        {
            Intent intent=new Intent(Productc.this,Login.class);
            startActivity(intent);
        }else{}
        super.onResume();
    }
