...
public class SerialTagInformationActivity  extends AppCompatActivity {
    TextView StoreIdTV;
    Button scanTagBtn;
    ArrayList<Inventory> categoryList = new ArrayList<Inventory>();
    SharedPreferences pref;
    Reader reader=null;
    private final SerialTagInformationActivity.BarcodeHandler mBarcodeHandler = new SerialTagInformationActivity.BarcodeHandler(this);
    ...
    private void readTag()
    {
        try{
            ...
            if(result==SDConsts.RFResult.SUCCESS)
            {
                ...
                if (result == SDConsts.RFResult.SUCCESS)
                {
                    Toast.makeText(SerialTagInformationActivity.this, "Reading......", Toast.LENGTH_SHORT).show();
                }
                else
                {
   ...
   /* @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.sound:
                Intent intent2 = new Intent(SerialTagInformationActivity.this, SoundManagerActivity.class);
                startActivity(intent2);
                return true;

            case R.id.bluetooth_reader:
                Intent intent3 = new Intent(SerialTagInformationActivity.this, TagInformationActivity.class);
    ...
    private static class BarcodeHandler extends Handler {
        private final WeakReference<SerialTagInformationActivity> mExecutor;
        public BarcodeHandler(SerialTagInformationActivity f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            SerialTagInformationActivity executor = mExecutor.get();
            if (executor != null) {
                    ...
                    case SDConsts.RFCmdMsg.READ:
                        if (m.arg2 == SDConsts.RFResult.SUCCESS){
                            if (m.obj != null  && m.obj instanceof String){
                                ...
                                //data= "E28011702000044A5A1F0A07";
                                new SearchByBarcodeAsyncTask(SerialTagInformationActivity.this,data.substring(0, 24)).execute(Constants.BASE_URL + "GetDetailsByBarcode.php");
    ...
    {
        try {
            AlertDialog.Builder dialog = new AlertDialog.Builder(SerialTagInformationActivity.this);
            ...
            if (result != null) {
                try
                {
                   ...
                   // System.out.println("jobj "+jobj.toString());
                    ...
                    TableRow tableRowBarcode = new TableRow(SerialTagInformationActivity.this);
                    ...
                    TextView tvBarcode = new TextView(SerialTagInformationActivity.this);
                    ...
                    /* create cell element - textview */
                    TextView tvBarcodeVal = new TextView(SerialTagInformationActivity.this);
                    ...
                    for (int j = 0; j < categoryHeaderArray.length(); j++) {
                        ...
                        /* create a header table row */
                        TableRow tableRow = new TableRow(SerialTagInformationActivity.this);
                        tableRow.setLayoutParams(tableRowParams);
                        tableRow.setBackgroundResource(R.drawable.platinum_color_rect);
                        tableRow.setPadding(4,9,4,9);
                        /* create cell element - textview */
                        TextView tv = new TextView(SerialTagInformationActivity.this);
                        ...
                        /* create cell element - textview */
                        TextView tv2 = new TextView(SerialTagInformationActivity.this);
                    ...
                    for(int k=0; k <lepcArray.length(); k++)
                    {
                        ...
                        /* create a header table row */
                        TableRow tableRowLocation = new TableRow(SerialTagInformationActivity.this);
                        ...
                        /* create cell element - textview */
                        TextView tvLocation = new TextView(SerialTagInformationActivity.this);
                        ...
                        /* create cell element - textview */
                        TextView tvLocationVal = new TextView(SerialTagInformationActivity.this);
                    ...
                    TableRow tableRowVariantAvailable = new TableRow(SerialTagInformationActivity.this);
                    ...
                    /* create cell element - textview */
                    TextView tableRowHeaderAvailable = new TextView(SerialTagInformationActivity.this);
                    ...
                    /* create cell element - textview /
                    TextView tableRowHeaderQty = new TextView(SerialTagInformationActivity.this);
                    ...
                    if(optionsArray.length() > 0)
                    {
                        ...
                        /* create a header table row */
                        TableRow tableRowVariant = new TableRow(SerialTagInformationActivity.this);
                        ...
                        /* create cell element - textview */
                        TextView tableRowVariantName = new TextView(SerialTagInformationActivity.this);
                        ...
                        /* create cell element - textview */
                        TextView tableRowVariantQty = new TextView(SerialTagInformationActivity.this);
                        ...
                        {
                            /* create a value table row */
                            TableRow tableRowVariantDesc = new TableRow(SerialTagInformationActivity.this);
                            ...
                            /* create cell element - textview */
                            TextView tableRowVariantDescName = new TextView(SerialTagInformationActivity.this);
                            ...
                            /* create cell element - textview */
                            TextView tableRowVQty = new TextView(SerialTagInformationActivity.this);
                     ...
                     e.printStackTrace();
                    Toast.makeText(SerialTagInformationActivity.this, "Something went wrong. Please try again", Toast.LENGTH_LONG).show();
                }
