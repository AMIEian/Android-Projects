...
public class MovementActivity extends AppCompatActivity {
    ...
    public void onResume(){
        super.onResume();
        if(Constants.isNetworkAvailable(MovementActivity.this)) {
            new StoreLocationDataAsyncTask(MovementActivity.this).execute(Constants.BASE_URL + "GetStoreLocation.php");
        }
        else
        {
            Constants.internetAlert(MovementActivity.this);
        }
            ...
            if (result != null) {
                try
                {
                    ...
                    for(int loc =0 ; loc< locationJArray.length(); loc++)
                    {
                        ...
                        Button button=new Button(MovementActivity.this);
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            public void onClick(View view) {
                                ...
                                try {
                                    ...
                                    Intent intent = new Intent(MovementActivity.this , SerialProcessMovementActivity.class);
                    ...
                    Toast.makeText(MovementActivity.this, "Something went wrong. Please try again", Toast.LENGTH_LONG).show();
                    finish();
                }
