...
public class SerialInventoryStockTakeAActivity extends AppCompatActivity {

    private static final String TAG = SerialInventoryStockTakeAActivity.class.getSimpleName();
    final Handler handlerButton = new Handler();
    private final SerialInventoryStockTakeAActivity.BarcodeHandler mBarcodeHandler = new SerialInventoryStockTakeAActivity.BarcodeHandler(this);
    public boolean timerstate = false;
    SharedPreferences pref;
    JSONObject locationObject;
    TextView StoreIdShopTV, progressTV, precentTV, timeTV, totalScanTV, batteryStatusTV;
    Button inventoryScanStartBtn, finishScanBtn, pauseScanBtn;
    ListView listView;
    String treeJSON = "";
    ...
    SerialInventoryStockTakeAActivity.ProcessEPCAndUpdateUIAsyncTask processEPCAndUpdateUIAsyncTask;
    ...
    private SerialInventoryStockTakeAActivity.SoundTask mSoundTask;
    //timer
    ...
    int testDataCounter = 0;
     String testEPC[] ={"E2801170200003825A1A0A07",
             "E2801170200015125A1D0A07",
             "E28011702000107F59DA0A07",
             "E2801170200004EF59D60A07",
             "E2801170200002DF5A1A0A07",
             "E280117020000100DF8309EF",
             "E2801170200003125A230A07",
             "E2801170200001725A210A07",
             "E2801170200001305A0C0A07",
             "E2801170200011405A0C0A07",
             "E2801170200015125A120A07",
             "E2801170200005405A120A07",
             "E2801170200015305A120A07",
             "E2801170200001905A0C0A07",
             "E2801170200013905A030A07",
             "E2801170200013125A0F0A07",
             "E2801170200001825A0C0A07",
             "E2801170200013225A0F0A07",
             "E2801170200015725A060A07"
     };*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(this, "Serial comm", Toast.LENGTH_SHORT).show();
        ...
        dbManager = new DBManager(SerialInventoryStockTakeAActivity.this);
        dbManager.open();
        dbManager.turcateStockTakeChecksum();

        pDialog = new ProgressDialog(SerialInventoryStockTakeAActivity.this);

        sessionId = Constants.getSessionId(SerialInventoryStockTakeAActivity.this);
        isSessionNew = Constants.isSessionNew(SerialInventoryStockTakeAActivity.this);
        ...
        internetStatusIB  = (ImageButton) findViewById(R.id.internetStatusIB);
        ...
        selectedBarcodeList = Constants.getArrayList(Constants.CATEGORY_ARRAY_JSON, SerialInventoryStockTakeAActivity.this);
        colors = getResources().getIntArray(R.array.colors_hex_code);

        if (Constants.isNetworkAvailable(SerialInventoryStockTakeAActivity.this)) {
            new  LoadTreeAsyncTask(SerialInventoryStockTakeAActivity.this).execute(Constants.DOMAIN_URL + "product_tree_by_barcode.php");
            internetStatusIB.setBackground(getResources().getDrawable(R.drawable.worldwide));
        } else {
            Constants.internetAlert(SerialInventoryStockTakeAActivity.this);
        ...
        collapseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new SerialInventoryStockTakeAActivity.ExpandCollapseAllAsyncTask(SerialInventoryStockTakeAActivity.this, false).execute();
            }
        });
        ...
        expandButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new SerialInventoryStockTakeAActivity.ExpandCollapseAllAsyncTask(SerialInventoryStockTakeAActivity.this, true).execute();
            }
        });
            ...
            public void onClick(View view) {
                ...
                if(is_paused == 1)
                {
                    ...
                    if (!mInventory) {
                        ...
                        //ret = mReader.RF_READ(SDConsts.RFMemType.EPC, 2, 7, "00000000", false);
                        //  ret = mReader.RF_PerformInventoryCustom(SDConsts.RFMemType.EPC, 0, 6, "00000000", false);
                        // ret = mReader.RF_PerformInventoryCustom(SDConsts.RFMemType.EPC, 1, 255, "00000000", false);
                        //  ret = mReader.RF_PerformInventoryCustom(SDConsts.RFMemType.TID, 0, 6, "00000000", false);
                        if (ret == SDConsts.RFResult.SUCCESS) {
                            ...
                            Toast.makeText(SerialInventoryStockTakeAActivity.this, "Start Inventory failed, Please check RFR900 MODE", Toast.LENGTH_SHORT).show();
                        else if (ret == SDConsts.RFResult.LOW_BATTERY)
                            Toast.makeText(SerialInventoryStockTakeAActivity.this, "Start Inventory failed, LOW_BATTERY", Toast.LENGTH_SHORT).show();
                        else
                            Log.d(TAG, "Start Inventory failed");
                    }
                }
                else //Paused button not pressed implemented on 11th Oct 2021
                {
                    totalScanTV.setText("0");
                    uniqueEPCList.clear();
                    totalScannedQty = 0;
                            ...
                            task = new TimerTask() {
                                ...
                                public void run() {
                                    handler.post(new Runnable() {
                                        public void run() {
                                            teamEPCAndUpdateUIAsyncTask = new TeamCountEPCAndUpdateUIAsyncTask();
        ...
        finishScanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                        SerialInventoryStockTakeAActivity.this);
                ...
                alertDialogBuilder
                        ...
                        .setPositiveButton("Abandon Scan", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (Constants.isNetworkAvailable(SerialInventoryStockTakeAActivity.this)) {
                                    new SerialInventoryStockTakeAActivity.RollbackStockTakeAsyncTask(SerialInventoryStockTakeAActivity.this).execute(Constants.BASE_URL + "RollBackStockTake.php");
                                } else {
                                    Constants.internetAlert(SerialInventoryStockTakeAActivity.this);
                                }
                                ...
                                if (ret == SDConsts.RFResult.SUCCESS || ret == SDConsts.RFResult.NOT_INVENTORY_STATE) {
                                    ...
                                    Toast.makeText(SerialInventoryStockTakeAActivity.this, "Stop Inventory failed", Toast.LENGTH_SHORT).show();
                        ...
                        .setNegativeButton("Submit Stock Take", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (ret == SDConsts.RFResult.SUCCESS || ret == SDConsts.RFResult.NOT_INVENTORY_STATE) {
                                    ...
                                    if (Constants.isNetworkAvailable(SerialInventoryStockTakeAActivity.this)) {
                                        new SerialInventoryStockTakeAActivity.ServerUpdateAsyncTask().execute(Constants.BASE_URL + "UpdateStockTake.php");
                                        internetStatusIB.setBackground(getResources().getDrawable(R.drawable.worldwide));
                                    } else {
                                        Constants.internetAlert(SerialInventoryStockTakeAActivity.this);
                                        internetStatusIB.setBackground(getResources().getDrawable(R.drawable.no_internet));
        ...
        pauseScanBtn = (Button) findViewById(R.id.pauseScanBtn);
        pauseScanBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (isLast) {
                    tv.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Toast.makeText(SerialInventoryStockTakeAActivity.this, "Clicked on: " + Title, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
    ...
    private void SoundLoadListener() {
        if (mSoundPool != null) {
            ...
            mSoundId = mSoundPool.load(SerialInventoryStockTakeAActivity.this, R.raw.beep, 1);
        }
    }
            ...
            case SDConsts.Msg.SDMsg:
                switch (m.arg1) {
                    ...
                    case SDConsts.SDCmdMsg.SLED_BATTERY_STATE_CHANGED:
                        //Toast.makeText(SerialInventoryStockTakeAActivity.this, "Battery state = " + m.arg2, Toast.LENGTH_SHORT).show();
                    ...
                    case SDConsts.SDCmdMsg.SLED_HOTSWAP_STATE_CHANGED:
                        if (m.arg2 == SDConsts.SDHotswapState.HOTSWAP_STATE)
                            Toast.makeText(SerialInventoryStockTakeAActivity.this, "HOTSWAP STATE CHANGED = HOTSWAP_STATE", Toast.LENGTH_SHORT).show();
                        else if (m.arg2 == SDConsts.SDHotswapState.NORMAL_STATE)
                            Toast.makeText(SerialInventoryStockTakeAActivity.this, "HOTSWAP STATE CHANGED = NORMAL_STATE", Toast.LENGTH_SHORT).show();
                        ...
                        if (m.arg2 == SDConsts.RFResult.SUCCESS) {
                            ...
                            try {
                                if (m.obj != null && m.obj instanceof String) {
                                    ...
                                    if (data != null && isFinsihButtonPressed == 0) {
                                        if (data.contains(";")) {
                                            ...
                                            if (mSoundTask == null) {
                                                mSoundTask = new SerialInventoryStockTakeAActivity.SoundTask();
                                                mSoundTask.execute();
                                            } else {
                                ...
                                if (Constants.isNetworkAvailable(SerialInventoryStockTakeAActivity.this)) {
                                    ...
                                    new AppCrashLogsAsyncTask("Reader Scan value: " + (String) m.obj + " " + exceptionAsString).execute(Constants.BASE_URL + "AppLogs.php");
                                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.sound: //Your task
                Intent intent2 = new Intent(SerialInventoryStockTakeAActivity.this, SoundManagerActivity.class);
                startActivity(intent2);

                return true;

            case R.id.bluetooth_reader: //Your task
                Intent intent3 = new Intent(SerialInventoryStockTakeAActivity.this, InventoryStockTakeAActivity.class);
    ...
    private void showMessageDialog() {
        try {
            if (isFinsihButtonPressed == 1) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(SerialInventoryStockTakeAActivity.this);
            ...
            dialog.setTitle(title)
                    ...
                    .setPositiveButton("Bluetooth Settings", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialoginterface, int i) {
                            ...
                            Intent intent = new Intent(SerialInventoryStockTakeAActivity.this, BTConnectivityActivity.class);
...
//          }})
    ...
    private static class BarcodeHandler extends Handler {
        private final WeakReference<SerialInventoryStockTakeAActivity> mExecutor;

        public BarcodeHandler(SerialInventoryStockTakeAActivity f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            SerialInventoryStockTakeAActivity executor = mExecutor.get();
            if (executor != null) {
    ...
    class LoadTreeAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
           ...
           /* Date d2 = new Date();
            ...
            if (Constants.isNetworkAvailable(SerialInventoryStockTakeAActivity.this)) {
                new  FetchBarcodeAndEPCAsyncTask(SerialInventoryStockTakeAActivity.this).execute(Constants.BASE_URL + "Get_Ethnicity_Bar_EPC_Data.php");
                internetStatusIB.setBackground(getResources().getDrawable(R.drawable.worldwide));
            } else {
                Constants.internetAlert(SerialInventoryStockTakeAActivity.this);
                internetStatusIB.setBackground(getResources().getDrawable(R.drawable.no_internet));
    ...
    class ServerUpdateAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(SerialInventoryStockTakeAActivity.this, "Stock take data uploaded successfully", Toast.LENGTH_LONG).show();
             finish();
            //System.out.println("ServerUpdateUIAsyncTask Resp " + result);
            /*System.out.println("currentTimeMillis after " + System.currentTimeMillis());*/

          /*  try {
                Intent intent = new Intent(SerialInventoryStockTakeAActivity.this, SerialStockTakeASummaryActivity.class);
    ...
    class RollbackStockTakeAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Toast.makeText(SerialInventoryStockTakeAActivity.this, "Scan Aborted Successfully", Toast.LENGTH_LONG).show();
            } catch (Exception e) {
                e.printStackTrace();
                ;
            }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int t = 0; t < summaryJSONArray.length(); t++)
                {
                    ...
                    LinearLayout parent = new LinearLayout(SerialInventoryStockTakeAActivity.this);

                    parent.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT));
                    parent.setOrientation(LinearLayout.VERTICAL);

                    LinearLayout ll2 = new LinearLayout(SerialInventoryStockTakeAActivity.this);
                    ...
                    final TextView child1 = new TextView(SerialInventoryStockTakeAActivity.this);
                    child1.setTextSize(TypedValue.COMPLEX_UNIT_SP, 12);

                    final TextView child2 = new TextView(SerialInventoryStockTakeAActivity.this);
                    ...
                    ProgressBar progressbar = new ProgressBar(SerialInventoryStockTakeAActivity.this, null, android.R.attr.progressBarStyleHorizontal);
                ...
                e.printStackTrace();
                Toast.makeText(SerialInventoryStockTakeAActivity.this, "Something went wrong during updating epc to server", Toast.LENGTH_LONG).show();
            }
