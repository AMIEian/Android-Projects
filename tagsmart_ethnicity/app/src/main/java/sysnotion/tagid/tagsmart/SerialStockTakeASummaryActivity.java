...
public class SerialStockTakeASummaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_serial_stock_take_a_summary);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        pref = getApplicationContext().getSharedPreferences(Constants.PREFS_NAME, MODE_PRIVATE);
        dbManager = new DBManager(SerialStockTakeASummaryActivity.this);

        pDialog = new ProgressDialog(SerialStockTakeASummaryActivity.this);
        ...
        collapseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new  ExpandCollapseAllAsyncTask(SerialStockTakeASummaryActivity.this,false).execute();
            }
        });
        ...
        expandButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new  ExpandCollapseAllAsyncTask(SerialStockTakeASummaryActivity.this,true).execute();
            }
        });
        ...
        if(Constants.isNetworkAvailable(SerialStockTakeASummaryActivity.this)) {
            new StockTakeSummaryAsyncTask(SerialStockTakeASummaryActivity.this).execute(Constants.BASE_URL+"StockTakeSummary.php");
        }
        else
        {
            Constants.internetAlert(SerialStockTakeASummaryActivity.this);
        }
    ...
    public void showPopupWindowClick(View view) {
        ...
        startScanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ret == SDConsts.RFResult.SUCCESS) {
                    ...
                    Toast.makeText(SerialStockTakeASummaryActivity.this, "Scan failed, Please check RFR900 MODE", Toast.LENGTH_SHORT).show();
                else if (ret == SDConsts.RFResult.LOW_BATTERY)
                    Toast.makeText(SerialStockTakeASummaryActivity.this, "Scan   failed, LOW_BATTERY", Toast.LENGTH_SHORT).show();
                else
        ...
        stopScanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //update to server
                if(Constants.isNetworkAvailable(SerialStockTakeASummaryActivity.this)) {
                    new UpdateEPCAsyncTask(SerialStockTakeASummaryActivity.this).execute(Constants.BASE_URL + "UpdateEPCBarcodeStockTake.php");
                }
                else
                {
                    Constants.internetAlert(SerialStockTakeASummaryActivity.this);
                ...
                if (ret == SDConsts.RFResult.SUCCESS || ret == SDConsts.RFResult.NOT_INVENTORY_STATE) {
                    ...
                    Toast.makeText(SerialStockTakeASummaryActivity.this, "Stop Inventory failed", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SoundLoadListener() {
        if (mSoundPool != null) {
            ...
            mSoundId = mSoundPool.load(SerialStockTakeASummaryActivity.this, R.raw.beep, 1);
        }
    }

    private static class BarcodeHandler extends Handler {
        private final WeakReference<SerialStockTakeASummaryActivity> mExecutor;
        public BarcodeHandler(SerialStockTakeASummaryActivity f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            SerialStockTakeASummaryActivity executor = mExecutor.get();
            if (executor != null) {
            ...
            case SDConsts.Msg.SDMsg:
                switch(m.arg1) {
                    ...
                    case SDConsts.SDCmdMsg.SLED_INVENTORY_STATE_CHANGED:
                        ...
                        Toast.makeText(SerialStockTakeASummaryActivity.this, "Inventory Stopped reason : " + m.arg2, Toast.LENGTH_SHORT).show();
                        break;
                    ...
                    case SDConsts.SDCmdMsg.SLED_BATTERY_STATE_CHANGED:
                        //Toast.makeText(SerialStockTakeASummaryActivity.this, "Battery state = " + m.arg2, Toast.LENGTH_SHORT).show();
                    ...
                    case SDConsts.SDCmdMsg.SLED_HOTSWAP_STATE_CHANGED:
                        if (m.arg2 == SDConsts.SDHotswapState.HOTSWAP_STATE)
                            Toast.makeText(SerialStockTakeASummaryActivity.this, "HOTSWAP STATE CHANGED = HOTSWAP_STATE", Toast.LENGTH_SHORT).show();
                        else if (m.arg2 == SDConsts.SDHotswapState.NORMAL_STATE)
                            Toast.makeText(SerialStockTakeASummaryActivity.this, "HOTSWAP STATE CHANGED = NORMAL_STATE", Toast.LENGTH_SHORT).show();
    ...
    private void processExactLocationData(int data) {
        ...
        if (mSoundTask == null) {
            mSoundTask = new SerialStockTakeASummaryActivity.SoundTask();
            mSoundTask.execute();
        }
        else {
    ...
    {
        try {
            AlertDialog.Builder dialog = new AlertDialog.Builder(SerialStockTakeASummaryActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case R.id.sound: //Your task
                Intent intent2 = new Intent(SerialStockTakeASummaryActivity.this, SoundManagerActivity.class);
    ...
    class StockTakeSummaryAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... string) {
            ...
            try {
                ...
                String sessionId = Constants.getSessionId(SerialStockTakeASummaryActivity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                try
                {
                    ...
                    mAdapter = new MissingEPCAdapter(SerialStockTakeASummaryActivity.this,  categoryList);
                   ...
                   // Log.i("stocktake summary", "treeJSON " + treeJSON);
                    ...
                    // e.printStackTrace();
                    Toast.makeText(SerialStockTakeASummaryActivity.this, "Something went wrong. Please try again", Toast.LENGTH_LONG).show();
                }
            ...
            if (result != null) {
                try
                {
                    ...
                    if( jObj.getString("status").compareTo("1") == 0)
                    {
                        ...
                        Toast.makeText(SerialStockTakeASummaryActivity.this, "Data updated", Toast.LENGTH_LONG).show();
